...
class CoursesController < ApplicationController
  ...
  # @returns [Course]
  def index
    unless params[:to_living].blank? 
      if params[:to_living] == 'true' 
        course_id = params[:sis_course_id]
        if @current_user == "student"
          redirect_to "https://google.com"+course_id.to_s
        else
          puts "**************@current_user*********"
          puts @current_user.class
          puts "**************course_id*********"
          puts course_id
          url = "https://baidudsdasda.com"+ course_id.to_s
          redirect_to url
        end
        return
      end
  ...
  def redirect_to_living
    unless param[:to_living].blank? 
      if param[:to_living] == true
