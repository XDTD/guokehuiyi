...
const selectedObservee = handleActions({
  SELECTED_OBSERVEE: (state, action) => {
    ...
    return {
      id: (_action$payload = action.payload) === null || _action$payload === void 0 ? void 0 : _action$payload.id,
      contextCodes: (_action$payload2 = action.payload) === null || _action$payload2 === void 0 ? void 0 : _action$payload2.contextCodes
    };
  },
