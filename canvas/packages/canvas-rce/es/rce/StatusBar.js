...
export default function StatusBar(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, {
    ...
    const toggleToHtmlTip = props.use_rce_pretty_html_editor ? formatMessage('Click or shift-click for the html editor.') : toggleToHtml;
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      onKeyUp: event => {
        if (props.use_rce_pretty_html_editor && props.editorView === WYSIWYG_VIEW && event.shiftKey && event.keyCode === 79) {
