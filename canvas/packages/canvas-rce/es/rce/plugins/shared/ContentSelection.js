 ...
 */
import { fromImageEmbed, fromVideoEmbed } from "../instructure_image/ImageEmbedOptions.js";
import { isOnlyTextSelected } from "../../contentInsertionUtils.js";
...
export function asImageEmbed($element) {
  ...
  return _objectSpread(_objectSpread({}, fromImageEmbed($element)), {}, {
    $element,
...
export function asLink($element, editor) {
  ...
  const _url$parse = url.parse($link.href),
...
export function asVideoElement($element) {
  ...
  return _objectSpread(_objectSpread({}, fromVideoEmbed($videoElem)), {}, {
    $element,
