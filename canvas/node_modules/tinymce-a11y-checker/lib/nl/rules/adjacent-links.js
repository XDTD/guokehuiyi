...
var _default = {
  ...
  message: () => "Aangrenzende koppelingen met dezelfde URL moeten \xE9\xE9n koppeling zijn.",
  why: () => "Gebruik de Tab-toets op het toetsenbord om te navigeren naar koppelingen. Twee aangrenzende koppelingen die naar dezelfde bestemming leiden, kunnen verwarrend werken bij gebruik van het toetsenbord.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => "Meer informatie over aangrenzende links"
};
