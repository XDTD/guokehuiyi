...
var _default = {
  ...
  form: () => [{
    ...
    dataKey: "action",
    options: [["nothing", "Ongewijzigd laten"], ["elem", "Hi\xEBrarchie van kopteksten corrigeren"], ["modify", "Koptekststijl verwijderen"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Slechtzienden bladeren snel door webpagina's, op zoek naar grote of vette koppen. Gebruikers van schermlezers zijn afhankelijk van koppen om een idee van de context te krijgen. Koppen moeten de juiste structuur hebben.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Meer informatie over ordenen van paginakopteksten"
};
