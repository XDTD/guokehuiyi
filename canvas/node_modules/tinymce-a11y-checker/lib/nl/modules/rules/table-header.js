...
export default {
  ...
  form: () => [{
    label: "Tablekop instellen",
    dataKey: "header",
    options: [["none", "Geen kopteksten"], ["row", "Koptekstrij"], ["col", "Koptekstkolom"], ["both", "Koptekstrij en -kolom"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Tabellen moeten minstens \xE9\xE9n kop hebben.",
  why: () => "Schermlezers kunnen geen tabellen zonder de juiste structuur interpreteren. Tabelkoppen geven een aanduiding van de inhoud.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H43.html",
  linkText: () => "Meer informatie over tabelkopteksten"
};