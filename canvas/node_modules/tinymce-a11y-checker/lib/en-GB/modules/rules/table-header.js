...
export default {
  ...
  form: () => [{
    ...
    dataKey: "header",
    options: [["none", "No headers"], ["row", "Header row"], ["col", "Header column"], ["both", "Header row and column"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Screen readers cannot interpret tables without the proper structure. Table headers provide direction and overview of the content.",
