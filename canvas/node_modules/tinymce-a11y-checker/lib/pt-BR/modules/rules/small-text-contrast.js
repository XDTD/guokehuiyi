...
export default {
  ...
  message: () => "Texto menor do que 18pt (ou negrito 14pt) deve exibir uma raz\xE3o m\xEDnima de contraste de 4.5:1.",
  why: () => "Texto \xE9 dif\xEDcil de ler sem contraste suficiente entre o texto e o plano de fundo, especialmente para aqueles com pouca vis\xE3o.",
