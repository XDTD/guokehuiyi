...
var _default = {
  ...
  form: () => [{
    label: "A\xE7\xE3o a tomar:",
    dataKey: "action",
    options: [["nothing", "Deixar como est\xE1"], ["elem", "Corrigir hierarquia de t\xEDtulos"], ["modify", "Remover estilo do t\xEDtulo"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "N\xEDveis de t\xEDtulos n\xE3o devem ser pulados.",
  why: () => "Deficientes visuais navegam rapidamente nas p\xE1ginas web, buscando t\xEDtulos grandes ou negritos. Usu\xE1rios de leitores de tela dependem dos cabe\xE7alhos para entendimento contextual. Os cabe\xE7alhos devem usar a estrutura adequada.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Saiba mais sobre a organiza\xE7\xE3o de cabe\xE7alhos da p\xE1gina"
};
