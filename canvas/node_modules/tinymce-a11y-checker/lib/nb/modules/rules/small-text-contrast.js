...
export default {
  ...
  message: () => "Tekst mindre enn 18pkt (eller tykk 14pkt) b\xF8r vises med en minimums kontrastrate p\xE5 4,5:1.",
  why: () => "Teksten er vanskelig \xE5 lese uten tilstrekkelig kontrast mellom tekst og bakgrunn, spesielt for svaksynte. ",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G17.html",
  linkText: () => "L\xE6r mer om fargekontrast"
};