...
export default {
  ...
  message: () => "Lenker ved siden av hverandre med samme URL b\xF8r v\xE6re samme lenke.",
  why: () => "Tastatur navigerer til lenker ved \xE5 bruke tabulatortasten. To lenker som viser til samme destinasjon kan v\xE6re forvirrende for tastaturbrukere.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => "L\xE6r mer om lenker ved siden av"
};