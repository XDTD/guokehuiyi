...
var _default = {
  ...
  form: () => [{
    label: (0, _formatMessage.default)("Merge links"),
    checkbox: true,
    dataKey: "combine"
  }],
  ...
  message: () => (0, _formatMessage.default)("Adjacent links with the same URL should be a single link."),
  why: () => (0, _formatMessage.default)("Keyboards navigate to links using the Tab key. Two adjacent links that direct to the same destination can be confusing to keyboard users."),
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => (0, _formatMessage.default)("Learn more about adjacent links")
};
