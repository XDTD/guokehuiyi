...
var _default = {
  ...
  form: () => [{
    label: (0, _formatMessage.default)("Action to take:"),
    dataKey: "action",
    options: [["nothing", (0, _formatMessage.default)("Leave as is")], ["elem", (0, _formatMessage.default)("Fix heading hierarchy")], ["modify", (0, _formatMessage.default)("Remove heading style")]]
  }],
  update: (elem, data) => {
  ...
  message: () => (0, _formatMessage.default)("Heading levels should not be skipped."),
  why: () => (0, _formatMessage.default)("Sighted users browse web pages quickly, looking for large or bolded headings. Screen reader users rely on headers for contextual understanding. Headers should use the proper structure."),
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => (0, _formatMessage.default)("Learn more about organizing page headings")
};
