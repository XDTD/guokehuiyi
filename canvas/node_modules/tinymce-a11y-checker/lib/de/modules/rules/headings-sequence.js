...
export default {
  ...
  form: () => [{
    label: "Auszuf\xFChrende T\xE4tigkeiten:",
    dataKey: "action",
    options: [["nothing", "Lassen, wie es ist"], ["elem", "Feste \xDCberschriftshierarchie"], ["modify", "\xDCberschriftsstil entfernen"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Die \xDCberschriftsebene darf nicht \xFCbersprungen werden.",
  why: () => "Sehende Benutzer durchsuchen Webseiten schnell nach gro\xDF- oder fettgedruckten \xDCberschriften. Benutzer von Bildschirmbetrachtern sind f\xFCr ein kontextbezogenes Verst\xE4ndnis auf \xDCberschriften angewiesen. \xDCberschriften sollten die entsprechende Struktur verwenden.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Weitere Informationen \xFCber das Organisieren der Seiten\xFCberschriften"
};