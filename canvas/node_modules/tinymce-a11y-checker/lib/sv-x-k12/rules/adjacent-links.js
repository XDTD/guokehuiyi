...
var _default = {
  ...
  message: () => "Intilliggande l\xE4nkar med samma webbadress ska vara en enda l\xE4nk.",
  why: () => "Tangentbord navigerar till l\xE4nkar via Tab-tangenten. Tv\xE5 intilliggande l\xE4nkar som leder till samma destination kan vara f\xF6rvirrande f\xF6r anv\xE4ndare av tangentbord.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => "L\xE4s mer om n\xE4rliggande l\xE4nkar"
};
