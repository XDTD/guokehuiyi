...
export default {
  ...
  form: () => [{
    label: "\xC5tg\xE4rd att vidta:",
    dataKey: "action",
    options: [["nothing", "L\xE4mna som det \xE4r"], ["elem", "Fast rubrik hierarki"], ["modify", "Ta bort rubrikstil"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Rubrikniv\xE5er b\xF6r inte hoppas \xF6ver.",
  why: () => "Visade anv\xE4ndare bl\xE4ddrar snabbt p\xE5 webbsidor och letar efter stora eller fetstil rubriker. Anv\xE4ndare av sk\xE4rml\xE4sare anv\xE4nder sig av rubriker f\xF6r kontextuell f\xF6rst\xE5else. Rubriker ska anv\xE4nda r\xE4tt struktur.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "L\xE4s mer om att ordna sidhuvuden"
};