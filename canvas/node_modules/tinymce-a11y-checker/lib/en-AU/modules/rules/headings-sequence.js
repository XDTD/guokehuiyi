...
export default {
  ...
  form: () => [{
    ...
    dataKey: "action",
    options: [["nothing", "Leave as is"], ["elem", "Fix heading hierarchy"], ["modify", "Remove heading style"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Sighted users browse web pages quickly, looking for large or bolded headings. Screen reader users rely on headers for contextual understanding. Headers should use the proper structure.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Learn more about organising page headings"
};