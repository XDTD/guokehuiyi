...
var _indicate = _interopRequireWildcard(require("../indicate"));
...
beforeEach(() => {
  ...
  jest.spyOn(window, "requestAnimationFrame").mockImplementationOnce(cb => cb()) // This only allows it to happen twice, preventing an infinite loop
...
it("removes any existing indicators when run", () => {
  ...
  (0, _indicate.default)(fakeEditor, fakeElem);
