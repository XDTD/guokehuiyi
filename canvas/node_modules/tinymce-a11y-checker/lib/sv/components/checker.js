...
class Checker extends _react.default.Component {
  ...
  render() {
    const rule = this.errorRule();
    const issueNumberMessage = "Problem " + (this.state.errorIndex + 1) + "/" + this.state.errors.length;
    return /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveAnnouncer, null, /*#__PURE__*/_react.default.createElement(_uiTray.Tray, {
      ...
      label: "Tillg\xE4nglighetskontroll\xF6r",
    ...
    }, "St\xE4ng tillg\xE4nglighetskontrollen"), /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div",
      ...
      as: "h2",
      margin: "medium 0"
    }, " " + "Tillg\xE4nglighetskontroll\xF6r"), this.state.errors.length > 0 && /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div"
    ...
    }, /*#__PURE__*/_react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Varf\xF6r"))), /*#__PURE__*/_react.default.createElement(_uiPopover.Popover.Content, null, /*#__PURE__*/_react.default.createElement(_uiView.View, {
      padding: "medium",
      display: "block",
      width: "16rem"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.CloseButton, {
    ...
    }, "St\xE4ng"), /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, rule.why()), /*#__PURE__*/_react.default.createElement("p", null, rule.link && rule.link.length && /*#__PURE__*/_react.default.createElement(_uiThemeable.ApplyTheme, {
      theme: {
        [_uiLink.Link.theme]: {
      ...
      margin: "0 small 0 0",
      "aria-label": "Previous"
    }, "F\xF6reg\xE5ende"), /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      onClick: () => this.nextError()
    }, "N\xE4sta")), /*#__PURE__*/_react.default.createElement(_uiGrid.GridCol, {
      width: "auto"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      type: "submit",
      variant: "primary",
      disabled: !this.state.formStateValid
    }, "Till\xE4mpa"))))))), this.state.errors.length === 0 && !this.state.checking && /*#__PURE__*/_react.default.createElement(_uiView.View, null, /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, "Inga tillg\xE4nglighetsproblem uppt\xE4cktes.")), /*#__PURE__*/_react.default.createElement(_placeholderSvg.default, null)), this.state.checking && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveMessage, {
      message: "Kontrollerar tillg\xE4nglighetsproblem",
      "aria-live": "polite"
    }), /*#__PURE__*/_react.default.createElement(_uiSpinner.Spinner, {
      title: "Kontrollerar tillg\xE4nglighetsproblem",
      margin: "medium auto"
    })))));
  }
