...
beforeEach(() => {
  ...
  component = shallow( /*#__PURE__*/React.createElement(Checker, {
    getBody: () => node,
    editor: fakeEditor
  }));
...
describe("check", () => {
  ...
  test("calls beforeCheck and afterCheck providing a done callback and an editor instance", async () => {
    component = shallow( /*#__PURE__*/React.createElement(Checker, {
      getBody: () => node,
      editor: _objectSpread(_objectSpread({}, fakeEditor), {}, {
        someObject: true
      })
    }));
    instance = component.instance();
  ...
  describe("close", () => {
    ...
    it("calls editor.on('Remove') when mounted", () => {
      component = mount( /*#__PURE__*/React.createElement(Checker, {
        getBody: () => node,
        editor: fakeEditor
      }));
      instance = component.instance();
