...
export default {
  ...
  form: () => [{
    label: "Handling \xE5 utf\xF8re:",
    dataKey: "action",
    options: [["nothing", "La det v\xE6re"], ["elem", "Reparer tittelhierarki"], ["modify", "Fjern tittelstil"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Tittelniv\xE5er b\xF8r ikke hoppes over",
  why: () => "Seende brukere surfer nettsider kjapt, og ser etter store eller uthevede titler. Brukere av skjermlesere er avhengige av titler for \xE5 forst\xE5 konteksten. Titler b\xF8r bruke korrekt struktur.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "L\xE6r mer om hvordan organisere sideoverskrifter"
};