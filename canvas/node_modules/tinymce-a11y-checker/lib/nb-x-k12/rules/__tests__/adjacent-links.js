...
var _adjacentLinks = _interopRequireDefault(require("../adjacent-links"));
...
describe("test", () => {
  test("returns true if not A element", () => {
    expect(_adjacentLinks.default.test(document.createElement("div"))).toBeTruthy();
  });
  test("returns true if no next child element", () => {
    expect(_adjacentLinks.default.test(a2)).toBeTruthy();
  });
  test("returns true if next A element does not have same href", () => {
    a1.setAttribute("href", "someval");
    expect(_adjacentLinks.default.test(a1)).toBeTruthy();
  });
  test("returns false if next A element has same null href", () => {
    expect(_adjacentLinks.default.test(a1)).toBeFalsy();
  });
...
describe("data", () => {
  test("returns the proper object", () => {
    expect(_adjacentLinks.default.data()).toMatchSnapshot();
  });
});
describe("form", () => {
  test("returns the proper object", () => {
    expect(_adjacentLinks.default.form()).toMatchSnapshot();
  });
});
describe("update", () => {
  test("returns same element", () => {
    expect(_adjacentLinks.default.update(a1, {})).toBe(a1);
  });
  test("returns A element with combined html content if 'combine' set", () => {
    ...
    const newA = _adjacentLinks.default.update(a1, {
      combine: true
    });
...
describe("rootNode", () => {
  test("returns the parentNode of an element", () => {
    expect(_adjacentLinks.default.rootNode(a1).tagName).toBe("BODY");
  });
});
describe("message", () => {
  test("returns the proper message", () => {
    expect(_adjacentLinks.default.message()).toMatchSnapshot();
  });
});
describe("why", () => {
  test("returns the proper why message", () => {
    expect(_adjacentLinks.default.why()).toMatchSnapshot();
  });
});
describe("linkText", () => {
  test("returns the proper linkText message", () => {
    expect(_adjacentLinks.default.linkText()).toMatchSnapshot();
  });
});