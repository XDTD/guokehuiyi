...
export default {
  ...
  message: () => "Les liens adjacents ayant la m\xEAme URL devraient \xEAtre rassembl\xE9s en un seul lien.",
  why: () => "Au clavier, on navigue parmi les liens \xE0 l\u2019aide de la touche tabulation. Lorsque deux liens adjacents renvoient \xE0 la m\xEAme destination, cela peut porter \xE0 confusion pour les utilisateurs au clavier.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => "Apprenez-en davantage sur les liens adjacents"
};