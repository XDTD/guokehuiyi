...
export default {
  ...
  form: () => [{
    ...
    dataKey: "action",
    options: [["nothing", "Deixe como est\xE1"], ["elem", "Fixar hierarquia"], ["modify", "Remova estilo de cabe\xE7alho"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Os n\xEDveis de t\xEDtulo n\xE3o devem ser ignorados.",
  why: () => "Utilizadores vistos navegam nas p\xE1ginas da Web rapidamente, procurando t\xEDtulos em grande ou em negrito. Os utilizadores do leitor de ecr\xE3 dependem de cabe\xE7alhos para a compreens\xE3o contextual. Os cabe\xE7alhos devem usar a estrutura adequada.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Saiba mais sobre como organizar t\xEDtulos de p\xE1gina"
};