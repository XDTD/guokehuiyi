...
test("describes an image", () => {
  ...
  expect((0, _describe.default)(elem)).toBe("Image with filename image.jpg");
});
test("describes a table", () => {
  ...
  `;
  expect((0, _describe.default)(elem)).toBe("Table starting with This is a test…");
});
test("describes a link", () => {
  const elem = document.createElement("a");
  elem.textContent = "something";
  expect((0, _describe.default)(elem)).toBe("Link with text starting with something");
});
test("describes a paragraph", () => {
  const elem = document.createElement("p");
  elem.textContent = "This is the text of a paragraph.";
  expect((0, _describe.default)(elem)).toBe("Paragraph starting with This is the text…");
});
test("describes a table header", () => {
  const elem = document.createElement("th");
  elem.textContent = "This is the text of a table header.";
  expect((0, _describe.default)(elem)).toBe("Table header starting with This is the text…");
});
test("describes a h1", () => {
  const elem = document.createElement("h1");
  elem.textContent = "This is a heading";
  expect((0, _describe.default)(elem)).toBe("Heading starting with This is a heading");
});
test("describes a h2", () => {
...
test("describes other elements", () => {
  ...
  expect((0, _describe.default)(elem)).toBe("Element starting with This is the text…");
});
test("returns null when there isn't a valid element", () => {
  const elem = void 0;
  expect((0, _describe.default)(elem)).toBe(null);
});