...
const promisify = _util.default.promisify;
...
beforeEach(() => {
  ...
  component = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_checker.default, {
    getBody: () => node,
    editor: fakeEditor
  }));
...
describe("check", () => {
  ...
  test("calls beforeCheck and afterCheck providing a done callback and an editor instance", async () => {
    component = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_checker.default, {
      getBody: () => node,
      editor: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, fakeEditor), {}, {
        someObject: true
      })
    }));
    instance = component.instance();
    ...
    const beforeCheck = (ed, done) => {
      expect(ed).toEqual(expect.objectContaining({
        someObject: true
      }));
      beforeCallback();
      done();
  ...
  describe("close", () => {
    ...
    it("calls editor.on('Remove') when mounted", () => {
      component = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_checker.default, {
        getBody: () => node,
        editor: fakeEditor
      }));
      instance = component.instance();
