...
class Checker extends _react.default.Component {
  ...
  render() {
    const rule = this.errorRule();
    const issueNumberMessage = "Vandam\xE1l " + (this.state.errorIndex + 1) + "/" + this.state.errors.length;
    return /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveAnnouncer, null, /*#__PURE__*/_react.default.createElement(_uiTray.Tray, {
    ...
    }, "Loka Accessibility CheckerAthugun \xE1 a\xF0gangi"), /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div",
      ...
      as: "h2",
      margin: "medium 0"
    }, " " + "Athugun \xE1 a\xF0gangi"), this.state.errors.length > 0 && /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div"
    ...
    }, /*#__PURE__*/_react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Hvers vegna"))), /*#__PURE__*/_react.default.createElement(_uiPopover.Popover.Content, null, /*#__PURE__*/_react.default.createElement(_uiView.View, {
      padding: "medium",
      display: "block",
      width: "16rem"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.CloseButton, {
    ...
    }, "Loka"), /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, rule.why()), /*#__PURE__*/_react.default.createElement("p", null, rule.link && rule.link.length && /*#__PURE__*/_react.default.createElement(_uiThemeable.ApplyTheme, {
      theme: {
        [_uiLink.Link.theme]: {
      ...
      margin: "0 small 0 0",
      "aria-label": "Previous"
    }, "Fyrri"), /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      onClick: () => this.nextError()
    }, "N\xE6sti")), /*#__PURE__*/_react.default.createElement(_uiGrid.GridCol, {
      width: "auto"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      type: "submit",
      variant: "primary",
      disabled: !this.state.formStateValid
    }, "Virkja"))))))), this.state.errors.length === 0 && !this.state.checking && /*#__PURE__*/_react.default.createElement(_uiView.View, null, /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, "Engin vandam\xE1l fundust var\xF0andi a\xF0gengi .")), /*#__PURE__*/_react.default.createElement(_placeholderSvg.default, null)), this.state.checking && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveMessage, {
      message: "Er a\xF0 kanna vandam\xE1l var\xF0andi a\xF0gengileika",
      "aria-live": "polite"
    }), /*#__PURE__*/_react.default.createElement(_uiSpinner.Spinner, {
      title: "Er a\xF0 kanna vandam\xE1l var\xF0andi a\xF0gengileika",
      margin: "medium auto"
    })))));
  }
