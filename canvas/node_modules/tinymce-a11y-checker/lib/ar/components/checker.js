...
class Checker extends _react.default.Component {
  ...
  render() {
    const rule = this.errorRule();
    const issueNumberMessage = "\u0645\u0634\u0643\u0644\u0629 " + (this.state.errorIndex + 1) + "/" + this.state.errors.length;
    return /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveAnnouncer, null, /*#__PURE__*/_react.default.createElement(_uiTray.Tray, {
      ...
      label: "\u0627\u0644\u0645\u062A\u062D\u0642\u0642 \u0645\u0646 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644",
    ...
    }, "\u0625\u063A\u0644\u0627\u0642 \u0627\u0644\u0645\u062A\u062D\u0642\u0642 \u0645\u0646 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644"), /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div",
      ...
      as: "h2",
      margin: "medium 0"
    }, " " + "\u0627\u0644\u0645\u062A\u062D\u0642\u0642 \u0645\u0646 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644"), this.state.errors.length > 0 && /*#__PURE__*/_react.default.createElement(_uiView.View, {
      as: "div"
    ...
    }, /*#__PURE__*/_react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "\u0627\u0644\u0633\u0628\u0628"))), /*#__PURE__*/_react.default.createElement(_uiPopover.Popover.Content, null, /*#__PURE__*/_react.default.createElement(_uiView.View, {
      padding: "medium",
      display: "block",
      width: "16rem"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.CloseButton, {
    ...
    }, "\u0625\u063A\u0644\u0627\u0642"), /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, rule.why()), /*#__PURE__*/_react.default.createElement("p", null, rule.link && rule.link.length && /*#__PURE__*/_react.default.createElement(_uiThemeable.ApplyTheme, {
      theme: {
        [_uiLink.Link.theme]: {
      ...
      margin: "0 small 0 0",
      "aria-label": "Previous"
    }, "\u0627\u0644\u0633\u0627\u0628\u0642"), /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      onClick: () => this.nextError()
    }, "\u0627\u0644\u062A\u0627\u0644\u064A")), /*#__PURE__*/_react.default.createElement(_uiGrid.GridCol, {
      width: "auto"
    }, /*#__PURE__*/_react.default.createElement(_uiButtons.Button, {
      type: "submit",
      variant: "primary",
      disabled: !this.state.formStateValid
    }, "\u062A\u0637\u0628\u064A\u0642"))))))), this.state.errors.length === 0 && !this.state.checking && /*#__PURE__*/_react.default.createElement(_uiView.View, null, /*#__PURE__*/_react.default.createElement(_uiText.Text, null, /*#__PURE__*/_react.default.createElement("p", null, "\u0644\u0645 \u064A\u062A\u0645 \u0627\u0644\u0643\u0634\u0641 \u0639\u0646 \u0645\u0634\u0627\u0643\u0644 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644.")), /*#__PURE__*/_react.default.createElement(_placeholderSvg.default, null)), this.state.checking && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_reactAriaLive.LiveMessage, {
      message: "\u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0645\u0634\u0627\u0643\u0644 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644",
      "aria-live": "polite"
    }), /*#__PURE__*/_react.default.createElement(_uiSpinner.Spinner, {
      title: "\u0627\u0644\u062A\u062D\u0642\u0642 \u0645\u0646 \u0645\u0634\u0627\u0643\u0644 \u0625\u0645\u0643\u0627\u0646\u064A\u0629 \u0627\u0644\u0648\u0635\u0648\u0644",
      margin: "medium auto"
    })))));
  }
