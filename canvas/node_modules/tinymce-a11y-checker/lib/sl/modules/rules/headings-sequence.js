...
export default {
  ...
  form: () => [{
    label: "Dejanje, ki ga je treba izvesti:",
    dataKey: "action",
    options: [["nothing", "Ne spreminjaj"], ["elem", "Popravi hierarhijo naslovov"], ["modify", "Odstrani slog naslova"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Slabovidni uporabniki hitro brskajo po spletnih straneh in i\u0161\u010Dejo velike ali krepko zapisane naslove. Uporabniki bralnikov zaslonov se za razumevanje konteksta zana\u0161ajo na glave. Pri glavah mora biti uporabljena pravilna zgradba.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Ve\u010D o organiziranju naslovov strani"
};