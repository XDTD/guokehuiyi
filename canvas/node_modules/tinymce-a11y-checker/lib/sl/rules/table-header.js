...
var _default = {
  ...
  form: () => [{
    label: "Nastavi glavo preglednice",
    dataKey: "header",
    options: [["none", "Ni glav."], ["row", "Vrstica z glavo"], ["col", "Stolpec z glavo"], ["both", "Vrstica in stolpec z glavo"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Bralniki zaslonov ne morejo tolma\u010Diti preglednic brez pravilne zgradbe. Glave preglednic zagotavljajo smeri in pregled vsebine.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H43.html",
  linkText: () => "Ve\u010D o glavah preglednic"
};
