...
var _default = {
  ...
  form: () => [{
    ...
    dataKey: "action",
    options: [["nothing", "Lascia cos\xEC"], ["elem", "Correggi gerarchia intestazioni"], ["modify", "Rimuovi stile intestazione"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Gli utenti senza problemi di vista esplorano le pagine web velocemente, cercando intestazioni in grassetto o di grandi dimensioni. Gli utenti di screen reader si affidano alle intestazioni per la comprensione contestuale. Le intestazioni devono utilizzare la struttura appropriata.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Per saperne di pi\xF9 sull'organizzazione delle intestazioni di pagina"
};
