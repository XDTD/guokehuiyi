...
export default {
  ...
  form: () => [{
    label: "Imposta intestazione tabella",
    dataKey: "header",
    options: [["none", "Nessuna intestazione"], ["row", "Riga di intestazione"], ["col", "Colonna intestazione"], ["both", "Riga e colonna di intestazione"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Gli screen reader non possono interpretare le tabelle senza la struttura corretta. Le intestazioni della tabella forniscono indicazioni e panoramica del contenuto.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H43.html",
  linkText: () => "Per saperne di pi\xF9 sulle intestazioni delle tabelle"
};