...
var _default = {
  ...
  form: () => [{
    label: "Defini ant\xE8t tablo",
    dataKey: "header",
    options: [["none", "Okenn ant\xE8t"], ["row", "Ranje ant\xE8t"], ["col", "Kolonn ant\xE8t"], ["both", "Ranje ak kolonn ant\xE8t"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Tablo yo dwe gen omwen yon ant\xE8t.",
  why: () => "Lekt\xE8 ekran yo paka ent\xE8rete tablo san estrikti ki apwopriye. Ant\xE8t tablo yo bay enstriksyon ak rezime kontni an.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H43.html",
  linkText: () => "Aprann plis sou ant\xE8t tablo yo"
};
