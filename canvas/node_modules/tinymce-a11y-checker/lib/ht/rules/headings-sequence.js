...
var _default = {
  ...
  form: () => [{
    label: "Aksyon ki dwe f\xE8t:",
    dataKey: "action",
    options: [["nothing", "Kite tankou"], ["elem", "Fikse yerachi ant\xE8t"], ["modify", "Elimine stil ant\xE8t"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Nivo ant\xE8t la pata dwe sote.",
  why: () => "Itilizat\xE8 prevwayan yo navige sou paj w\xE8b yo byen vit, pou yo ka ch\xE8che ant\xE8t ki gwo oswa an gra. Itilizat\xE8 lekt\xE8 ekran yo konte sou ant\xE8t yo pou konpreyansyon konteksty\xE8l. Ant\xE8t yo dwe itilize estrikti ki apwopriye.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Aprann plis sou \xF2ganizasyon ant\xE8t paj"
};
