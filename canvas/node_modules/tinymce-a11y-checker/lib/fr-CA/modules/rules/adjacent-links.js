...
export default {
  ...
  message: () => "Liens adjacents avec la m\xEAme URL devrait \xEAtre une liaison unique.",
  why: () => "Les claviers naviguent vers les liens \xE0 l'aide de la touche de tabulation. Deux liens adjacents qui vous dirigent vers la m\xEAme destination peuvent \xEAtre source de confusion pour les utilisateurs de clavier.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H2.html",
  linkText: () => "En apprendre davantage  sur les liens adjacents"
};