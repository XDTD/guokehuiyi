...
export default {
  ...
  form: () => [{
    ...
    dataKey: "action",
    options: [["nothing", "Laisser comme tel"], ["elem", "Corriger la hi\xE9rarchie d\u2019ent\xEAte"], ["modify", "Retirer le style d\u2019ent\xEAte"]]
  }],
  update: (elem, data) => {
