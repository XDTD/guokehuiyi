...
export default {
  ...
  form: () => [{
    label: "Handling, der skal tages:",
    dataKey: "action",
    options: [["nothing", "Lad det v\xE6re, som det er"], ["elem", "Ret overskriftshierarki"], ["modify", "Fjern overskriftsstil"]]
  }],
  update: (elem, data) => {
  ...
  message: () => "Overskriftsniveauer b\xF8r ikke springes over.",
  why: () => "Brugere, der er i stand til at se, gennemser websider hurtigt og leder efter store overskrifter. Sk\xE6rml\xE6sere er afh\xE6ngige af overskrifter for kontekstuel forst\xE5else. Overskrifter b\xF8r anvende den rigtige struktur.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "F\xE5 mere at vide om at organisere sideoverskrifter"
};