...
export default {
  ...
  form: () => [{
    label: "Pennu pennawd y tabl",
    dataKey: "header",
    options: [["none", "Dim pennawd"], ["row", "Rhes y pennawd"], ["col", "Colofn y pennawd"], ["both", "Colofn a rhes y pennawd"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Ni all darllenwyr sgrin ddehongli tablau heb y strwythur priodol. Mae penawdau tablau yn rhoi trosolwg o\u2019r cynnwys a\u2019i gyfeiriad.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/H43.html",
  linkText: () => "Dysgu mwy am benawdau tablau"
};