...
export default {
  ...
  form: () => [{
    label: "Cam gweithredu i'w gymryd:",
    dataKey: "action",
    options: [["nothing", "Gadael fel y mae"], ["elem", "Pennu hierarchaeth penawdau"], ["modify", "Tynnu arddull y pennawd"]]
  }],
  update: (elem, data) => {
  ...
  why: () => "Mae defnyddwyr sy'n gweld yn dda yn pori drwy dudalennau gwe yn gyflym, gan chwilio am benawdau mawr neu drwm. Mae defnyddwyr darllenwyr sgrin yn dibynnu ar benawdau i ddeall y cyd-destun. Dylai penawdau ddefnyddio'r strwythur priodol.",
  link: "https://www.w3.org/TR/WCAG20-TECHS/G141.html",
  linkText: () => "Dysgu mwy am drefnu penawdau tudalennau"
};