...
**/
var FormFieldLabel = (_dec = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(FormFieldLabel, _Component);

  var _super = (0, _createSuper2.default)(FormFieldLabel);
  ...
  (0, _createClass2.default)(FormFieldLabel, [{
    ...
    value: function render() {
      ...
      var ElementType = (0, _getElementType.getElementType)(FormFieldLabel, this.props);
      var classes = (_classes = {}, (0, _defineProperty2.default)(_classes, styles.root, true), (0, _defineProperty2.default)(_classes, styles['has-content'], (0, _hasVisibleChildren.hasVisibleChildren)(this.props.children)), _classes);
      return /*#__PURE__*/_react.default.createElement(ElementType, Object.assign({}, (0, _omitProps.omitProps)(this.props, FormFieldLabel.propTypes), {
