...
exports.DateTimeInput = exports.default = void 0;
...
---
**/
var DateTimeInput = (_dec = (0, _testable.testable)(), _dec2 = (0, _deprecated.deprecated)('7.0.0', null, 'Use @instructure/ui-date-input and @instructure/ui-select instead'), _dec(_class = _dec2(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(DateTimeInput, _Component);

  var _super = (0, _createSuper2.default)(DateTimeInput);

  function DateTimeInput(props, context) {
    var _this;

    (0, _classCallCheck2.default)(this, DateTimeInput);
    ...
    _this.state = (0, _objectSpread2.default)({}, _this.parseISO(props.value || props.defaultValue));
    _this._dateInput = null;
    _this._timeInput = null;
    return _this;
  }

  (0, _createClass2.default)(DateTimeInput, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (isUpdated) {
        this.setState(function (prevState) {
          ...
          return (0, _objectSpread2.default)({}, _this2.parseISO(iso, nextProps.locale, nextProps.timezone));
        });
      }
    }
  }, {
    ...
    value: function parseISO() {
      ...
      var parsed = _DateTime.DateTime.parse(iso, locale, timezone);
      ...
      return {
        iso: void 0,
        message: iso ? this.getErrorMessage.apply(this, (0, _toConsumableArray2.default)(iso.split('T'))) : null
      };
    }
  }, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_FormFieldGroup.FormFieldGroup, {
        description: description,
        colSpacing: "medium",
        rowSpacing: "small",
        layout: layout,
        vAlign: "top",
        messages: [].concat((0, _toConsumableArray2.default)(message ? [message] : []), (0, _toConsumableArray2.default)(messages || []))
      }, /*#__PURE__*/_react.default.createElement(_DateInput.DateInput, {
        dateValue: iso,
  ...
  **/
  datePreviousLabel: _propTypes.default.string.isRequired,

  /**
  * The label to put on the next month button of the calendar.
  **/
  dateNextLabel: _propTypes.default.string.isRequired,
  ...
  **/
   ...
   */
  timeStep: _propTypes.default.oneOf([5, 10, 15, 20, 30, 60]),
  ...
  **/
  invalidDateTimeMessage: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.func]).isRequired,
  ...
  * including localized formats.
  **/
  messageFormat: _propTypes.default.string,
  ...
  **/
  dateInputRef: _propTypes.default.func,

  /**
  * The <input> element where the time is entered.
  **/
  timeInputRef: _propTypes.default.func,
