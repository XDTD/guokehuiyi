...
var _IconCheckSolid = require("@instructure/ui-icons/lib/IconCheckSolid");
...
---
**/
var ToggleFacade = (_dec = (0, _themeable.themeable)(_theme.default, styles, _themeAdapter.themeAdapter), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(ToggleFacade, _Component);

  var _super = (0, _createSuper2.default)(ToggleFacade);

  function ToggleFacade() {
    (0, _classCallCheck2.default)(this, ToggleFacade);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(ToggleFacade, [{
    key: "renderIcon",
    value: function renderIcon() {
      if (this.props.checked) {
        return /*#__PURE__*/_react.default.createElement(_IconCheckSolid.IconCheckSolid, {
          className: styles.iconSVG
        });
      } else {
        return /*#__PURE__*/_react.default.createElement(_IconXSolid.IconXSolid, {
          className: styles.iconSVG
        });
      }
    }
    ...
    value: function renderLabel() {
      ...
      var classes = (_classes = {}, (0, _defineProperty2.default)(_classes, styles.label, true), (0, _defineProperty2.default)(_classes, styles.top, labelPlacement === 'top'), (0, _defineProperty2.default)(_classes, styles.start, labelPlacement === 'start'), (0, _defineProperty2.default)(_classes, styles.end, labelPlacement === 'end'), _classes);
    ...
    value: function render() {
      ...
      var classes = (_classes2 = {}, (0, _defineProperty2.default)(_classes2, styles.facade, true), (0, _defineProperty2.default)(_classes2, styles.checked, checked), (0, _defineProperty2.default)(_classes2, styles.disabled, disabled), (0, _defineProperty2.default)(_classes2, styles.focused, focused), (0, _defineProperty2.default)(_classes2, styles.top, labelPlacement === 'top'), (0, _defineProperty2.default)(_classes2, styles.start, labelPlacement === 'start'), (0, _defineProperty2.default)(_classes2, styles.end, labelPlacement === 'end'), (0, _defineProperty2.default)(_classes2, styles[size], true), _classes2);
      var rootClasses = (0, _defineProperty2.default)({}, styles.root, true);
      ...
      return /*#__PURE__*/_react.default.createElement("span", {
        className: (0, _classnames.default)(rootClasses)
      }, (labelPlacement === 'top' || labelPlacement === 'start') && this.renderLabel(), /*#__PURE__*/_react.default.createElement("span", {
        className: (0, _classnames.default)(classes),
        "aria-hidden": "true"
