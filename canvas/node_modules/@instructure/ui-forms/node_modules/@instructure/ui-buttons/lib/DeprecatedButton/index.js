...
exports.DeprecatedButton = exports.default = void 0;
...
var DeprecatedButton = (_dec = (0, _deprecated.deprecated)('8.0.0', null, 'Use Button from ui-buttons instead. See the upgrade guide for detailed instructions on updating https://instructure.design/#button-upgrade-guide'), _dec2 = (0, _testable.testable)(), _dec3 = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = _dec2(_class = _dec3(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(DeprecatedButton, _Component);

  var _super = (0, _createSuper2.default)(DeprecatedButton);

  function DeprecatedButton() {
    var _this;

    (0, _classCallCheck2.default)(this, DeprecatedButton);
    ...
    _this.handleKeyDown = function (e) {
      ...
      if (_this.elementType !== 'button' && (e.keyCode === _keycode.default.codes.space || e.keyCode === _keycode.default.codes.enter)) {
        e.preventDefault();
        e.stopPropagation();
  ...
  (0, _createClass2.default)(DeprecatedButton, [{
    key: "focus",
    ...
    value: function render() {
      ...
      var IHaveVisibleChildren = (0, _hasVisibleChildren.hasVisibleChildren)(this.props.children);
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (this.hasVisibleChildren) {
          _react.default.Children.forEach(children, function (child) {
            ...
            /*#__PURE__*/
            ( /*#__PURE__*/0, _console.warn)(!icon, "[DeprecatedButton] Icons as children is deprecated. Please use the 'icon' prop instead.");
          });
        }
      } // warn for unallowed view props


      var passthroughProps = _View.View.omitViewProps((0, _omitProps.omitProps)(this.props, DeprecatedButton.propTypes), DeprecatedButton);

      return /*#__PURE__*/_react.default.createElement(_View.View, Object.assign({}, passthroughProps, {
        className: (0, _classnames2.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, styles.root, true), (0, _defineProperty2.default)(_classnames, styles[variant], true), (0, _defineProperty2.default)(_classnames, styles[size], size), (0, _defineProperty2.default)(_classnames, styles["width--".concat(this.buttonWidth(hasOnlyIcon))], true), (0, _defineProperty2.default)(_classnames, styles["borderRadius--".concat(this.buttonBorderRadius())], true), (0, _defineProperty2.default)(_classnames, styles.disabled, disabled), (0, _defineProperty2.default)(_classnames, styles['has-icon'], icon), _classnames)),
      ...
      }), hasTextAndIcon ? /*#__PURE__*/_react.default.createElement(_Flex.Flex, {
        height: "100%",
        width: "100%"
      }, /*#__PURE__*/_react.default.createElement(_Flex.Flex.Item, {
        padding: "0 x-small 0 0"
      }, this.renderIcon()), /*#__PURE__*/_react.default.createElement(_Flex.Flex.Item, {
        shouldGrow: true,
        shouldShrink: true
    ...
    key: "elementType",
    get: function get() {
      return (0, _getElementType.getElementType)(DeprecatedButton, this.props);
    }
  }, {
    key: "focused",
    get: function get() {
  ...
  variant: _propTypes.default.oneOf(['default', 'primary', 'success', 'danger', 'light', 'ghost', 'ghost-inverse', 'link', 'link-inverse', 'circle-default', 'circle-primary', 'circle-danger', 'icon', 'icon-inverse']),
  ...
  * children.
  */
  icon: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.element]),
...
exports.DeprecatedButton = DeprecatedButton;
var _default = DeprecatedButton;
