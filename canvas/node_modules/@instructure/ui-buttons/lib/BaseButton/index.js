...
---
**/
var BaseButton = (_dec = (0, _testable.testable)(), _dec2 = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = _dec2(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(BaseButton, _Component);

  var _super = (0, _createSuper2.default)(BaseButton);
  ...
  (0, _createClass2.default)(BaseButton, [{
    ...
    value: function renderChildren() {
      ...
      var wrappedChildren = /*#__PURE__*/_react.default.createElement("span", {
      ...
      var wrappedIcon = /*#__PURE__*/_react.default.createElement("span", {
        className: styles.iconSVG
      }, (0, _callRenderProp.callRenderProp)(renderIcon));

      var flexChildren = hasOnlyIconVisible ? /*#__PURE__*/_react.default.createElement(_Flex.Flex.Item, null, wrappedIcon, children) : [/*#__PURE__*/_react.default.createElement(_Flex.Flex.Item, {
        key: "icon",
        padding: "0 ".concat(isCondensed ? 'xx-small' : 'x-small', " 0 0")
      }, wrappedIcon), /*#__PURE__*/_react.default.createElement(_Flex.Flex.Item, {
        key: "children",
        shouldShrink: true
      }, wrappedChildren)];
      var flexProps = {
      ...
      return /*#__PURE__*/_react.default.createElement(_Flex.Flex, flexProps, flexChildren);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props3, ["type", "size", "elementRef", "as", "href", "color", "focusColor", "textAlign", "shape", "display", "withBackground", "withBorder", "isCondensed", "margin", "cursor", "onClick", "renderIcon", "tabIndex"]);
      var interaction = this.interaction;
      var isDisabled = interaction === 'disabled';
      var isReadOnly = interaction === 'readonly';
      var isEnabled = interaction === 'enabled';
      var hasOnlyIconVisible = this.hasOnlyIconVisible;
      var classes = (0, _classnames2.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, styles.content, true), (0, _defineProperty2.default)(_classnames, styles["size--".concat(size)], true), (0, _defineProperty2.default)(_classnames, styles["color--".concat(color)], true), (0, _defineProperty2.default)(_classnames, styles["textAlign--".concat(textAlign)], true), (0, _defineProperty2.default)(_classnames, styles["shape--".concat(shape)], true), (0, _defineProperty2.default)(_classnames, styles.withBackground, withBackground), (0, _defineProperty2.default)(_classnames, styles.withoutBackground, !withBackground), (0, _defineProperty2.default)(_classnames, styles.isCondensed, isCondensed), (0, _defineProperty2.default)(_classnames, styles.withBorder, withBorder), (0, _defineProperty2.default)(_classnames, styles.withoutBorder, !withBorder), (0, _defineProperty2.default)(_classnames, styles.hasOnlyIconVisible, hasOnlyIconVisible), (0, _defineProperty2.default)(_classnames, styles.isDisabled, isDisabled), _classnames));
    ...
    key: "focused",
    get: function get() {
      return (0, _isActiveElement.isActiveElement)(this._rootElement);
    }
  }]);
