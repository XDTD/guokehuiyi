...
exports.ScreenReaderFocusRegion = exports.default = void 0;
...
var ScreenReaderFocusRegion = /*#__PURE__*/function () {
  function ScreenReaderFocusRegion(element) {
    ...
    (0, _classCallCheck2.default)(this, ScreenReaderFocusRegion);
    this._observer = null;
    this._attributes = [];
    this._nodes = [];
    this._parents = [];
  ...
  (0, _createClass2.default)(ScreenReaderFocusRegion, [{
    key: "updateElement",
    ...
    value: function parseIframeBodies(node) {
      ...
      return iframes.map(function (iframe) {
        ...
        try {
          ...
          /*#__PURE__*/
          ( /*#__PURE__*/0, _console.warn)(false, "[ui-a11y] could not find a document for iframe: ".concat(e), iframe);
        }
