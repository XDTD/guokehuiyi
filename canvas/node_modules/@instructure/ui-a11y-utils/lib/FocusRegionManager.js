...
exports.FocusRegionManager = exports.default = void 0;

var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));

var _console = require("@instructure/console");

var _FocusRegion = require("./FocusRegion.js");

var ENTRIES = [];

var FocusRegionManager = function FocusRegionManager() {
  (0, _classCallCheck2.default)(this, FocusRegionManager);
};
...
FocusRegionManager.focusRegion = function (element) {
  ...
  if (entry && entry.region && typeof entry.region.focus === 'function') {
    ...
    /*#__PURE__*/
    ( /*#__PURE__*/0, _console.error)(false, "[FocusRegionManager] Could not focus region with element: ".concat(element));
  }
};
...
FocusRegionManager.addEntry = function (element) {
  ...
  var region = new _FocusRegion.FocusRegion(element, options);
