...
var translateDefaultRatingDescriptions = function translateDefaultRatingDescriptions(description) {
  switch (description) {
    case 'DEFAULT_EXCEEDS_MASTERY':
      return (0, _formatMessage.default)('Exceeds Mastery');

    case 'DEFAULT_MASTERY':
      return (0, _formatMessage.default)('Mastery');

    case 'DEFAULT_NEAR_MASTERY':
      return (0, _formatMessage.default)('Near Mastery');

    case 'DEFAULT_BELOW_MASTERY':
      return (0, _formatMessage.default)('Below Mastery');

    case 'DEFAULT_NO_EVIDENCE':
      return (0, _formatMessage.default)('No Evidence');
