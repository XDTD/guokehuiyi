...
var _OutcomesPerStudentReport = _interopRequireDefault(require("../OutcomesPerStudentReport"));
...
describe('OutcomesPerStudentReport', function () {
  function makeProps() {
    return {
      users: [{
        id: 1,
  ...
  it('renders', function () {
    var wrapper = (0, _enzyme.mount)(_react.default.createElement("div", {
      id: "app"
    }, _react.default.createElement(_OutcomesPerStudentReport.default, makeProps())));
    (0, _chai.expect)(wrapper.find(".".concat(styles.background))).to.have.length(1);
  });
});