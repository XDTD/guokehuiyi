...
var _default_da_number = Intl.NumberFormat("da", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _n === 1 || _t !== 0 && (_i === 0 || _i === 1) ? "1 studerende" : _default_da_number(tier.count) + " studerende")))));
};
