  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
      ...
      switch (this.props.outcomePickerState) {
        ...
        case 'choosing':
          if (this.props.anyOutcomeSelected) {
            return "Bekr\xE4fta justeringar";
          } else {
            return "Klar";
          }
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Avbryt"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Bifogade l\xE4randem\xE5l"))), _react.default.createElement(ModalBody, {
        padding: "0",
