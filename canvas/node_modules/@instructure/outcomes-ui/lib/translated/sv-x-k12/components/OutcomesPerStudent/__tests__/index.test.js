...
_chai.default.use(require('sinon-chai'));

describe('OutcomesPerStudent/index', function () {
  function makeProps() {
    var props = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return Object.assign({
      loadPage: _sinon.default.stub().returns(Promise.resolve()),
      getReportOutcome: _sinon.default.stub().returns({
        id: 1,
        label: 'Foo.PRQ.2',
        title: 'Learn stuff'
      }),
      getScore: _sinon.default.spy(),
      setError: _sinon.default.spy(),
  ...
  it('renders a header for each outcome', function () {
    ...
    (0, _chai.expect)(wrapper.find('Header')).to.have.length(3);
  });
  it('generates the correct viewReportAlignment method for each header', function () {
    ...
    viewReportAlignment();
    (0, _chai.expect)(props.viewReportAlignment).to.have.been.calledOnce;
    (0, _chai.expect)(props.viewReportAlignment).to.have.been.calledWith(303);
  });
  it('renders a row for each student', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_index.default, makeProps()), {
      disableLifecycleMethods: true
    });
    (0, _chai.expect)(wrapper.find(".".concat(styles.studentRow))).to.have.length(5);
  });
  it('renders a score for each student score', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_index.default, makeProps()), {
      disableLifecycleMethods: true
    });
    (0, _chai.expect)(wrapper.find('Score')).to.have.length(15);
  });
  it('renders pagination', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_index.default, makeProps()), {
      disableLifecycleMethods: true
    });
    (0, _chai.expect)(wrapper.find('PaginationButton')).to.have.length(5);
  });
  it('renders the billboard message if no results yet exist', function () {
    ...
    (0, _chai.expect)(wrapper.find('Billboard').prop('heading')).to.equal('Looks like you\'re a little early');
  });
  it('renders the billboard message if no outcomes are aligned', function () {
    ...
    (0, _chai.expect)(wrapper.find('Billboard').prop('heading')).to.equal('There is no report here to show');
  });
