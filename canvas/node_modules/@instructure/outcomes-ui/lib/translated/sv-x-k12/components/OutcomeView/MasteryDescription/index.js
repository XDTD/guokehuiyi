...
var _percent_svXK12_number = Intl.NumberFormat("sv-x-k12", { style: "percent" }).format,
    _default_svXK12_number = Intl.NumberFormat("sv-x-k12", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return "M\xE5luppfyllelse ber\xE4knad genom minskande medelv\xE4rde. Senast ber\xE4knad som " + _percent_svXK12_number(scoringMethod.algorithm_data.decaying_average_percent) + " av m\xE5luppfyllelsevikt, medelv\xE4rdet av alla andra resultat r\xE4knas som " + _percent_svXK12_number(1.0 - scoringMethod.algorithm_data.decaying_average_percent) + " av vikten. Om det enbart finns ett resultat kommer det enskilda resultatet att returneras.";

    case 'n_mastery':
      return "M\xE5luppfyllelse ber\xE4knad vid n antal g\xE5nger. M\xE5ste uppn\xE5 m\xE5luppfyllelse minst " + _default_svXK12_number(scoringMethod.algorithm_data.n_mastery_count) + " g\xE5nger.  Resultat \xF6ver m\xE5luppfyllelse kommer att medelv\xE4rde ber\xE4knas f\xF6r ber\xE4kning av slutresultat.";

    case 'highest':
      return "M\xE5luppfyllelse ber\xE4knad via h\xF6gsta resultat. M\xE5luppfyllelsepo\xE4ng \xE5terspeglar h\xF6gsta resultat av en betygsatt bed\xF6mning.";

    case 'latest':
      return "M\xE5luppfyllelse ber\xE4knad med senaste resultat. M\xE5luppfyllelseresultat \xE5terspeglar den senaste betygsbed\xF6mningen.";
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return "Genom att justera till detta " + artifactTypeName + " om eleven f\xE5r b\xE4ttre resultat \xE4n " + _percent_svXK12_number(masteryPercent) + " kommer m\xE5luppfyllelse att uppn\xE5s.";
};
