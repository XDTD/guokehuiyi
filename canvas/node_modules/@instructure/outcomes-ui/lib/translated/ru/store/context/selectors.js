...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_v = (_s + '.').split('.')[1].length, _i2 = Math.floor(Math.abs(+_s)), _v === 0 && _i2 % 10 === 1 && _i2 % 100 !== 11 ? _default_ru_number(count) + " \u0413\u0440\u0443\u043F\u043F\u0430" : _default_ru_number(count) + " \u0413\u0440\u0443\u043F\u043F\u044B");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_v2 = (_s2 + '.').split('.')[1].length, _i3 = Math.floor(Math.abs(+_s2)), _v2 === 0 && _i3 % 10 === 1 && _i3 % 100 !== 11 ? _default_ru_number(count) + " \u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442" : _default_ru_number(count) + " \u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B");
};
