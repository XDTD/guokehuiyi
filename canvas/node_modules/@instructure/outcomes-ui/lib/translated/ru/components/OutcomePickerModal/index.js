  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
      ...
      switch (this.props.outcomePickerState) {
        ...
        case 'choosing':
          if (this.props.anyOutcomeSelected) {
            return "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C \u0441\u043E\u0433\u043B\u0430\u0441\u043E\u0432\u0430\u043D\u0438\u044F";
          } else {
            return "\u0413\u043E\u0442\u043E\u0432\u043E";
          }
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "\u0412\u043B\u043E\u0436\u0435\u043D\u043D\u044B\u0435 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B"))), _react.default.createElement(ModalBody, {
        padding: "0",
