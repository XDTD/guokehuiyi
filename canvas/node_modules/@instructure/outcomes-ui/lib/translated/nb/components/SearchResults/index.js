...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(SearchResults, [{
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "S\xF8ket kom tilbake uten noe resultater" : (_n === 1 ? _default_nb_number(searchTotal) + " resultat" : _default_nb_number(searchTotal) + " resultater");
    }
  }, {
    key: "renderResults",
