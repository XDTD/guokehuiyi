  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Peruuta"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Liitetyt tulokset"))), _react.default.createElement(ModalBody, {
        padding: "0",
