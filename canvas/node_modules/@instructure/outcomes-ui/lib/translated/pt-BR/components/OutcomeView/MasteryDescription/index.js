...
var _percent_ptBR_number = Intl.NumberFormat("pt-BR", { style: "percent" }).format,
    _default_ptBR_number = Intl.NumberFormat("pt-BR", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return "Dom\xEDnio calculado pela M\xE9dia em Deteriora\xE7\xE3o. O mais recente conta como " + _percent_ptBR_number(scoringMethod.algorithm_data.decaying_average_percent) + " do peso de dom\xEDnio, m\xE9dia de todos os outros resultados conta como " + _percent_ptBR_number(1.0 - scoringMethod.algorithm_data.decaying_average_percent) + " do peso. Se houver apenas um resultado, a pontua\xE7\xE3o \xFAnica ser\xE1 retornada.";

    case 'n_mastery':
      return "Dom\xEDnio calculado pelo N\xFAmero n de Tempos. Deve alcan\xE7ar dom\xEDnio ao menos " + _default_ptBR_number(scoringMethod.algorithm_data.n_mastery_count) + " vezes.  Pontua\xE7\xF5es acima do dom\xEDnio ter\xE3o valor m\xE9dio para calcular pontua\xE7\xE3o final.";

    case 'highest':
      return "Dom\xEDnio calculado pela nota mais alta. Pontua\xE7\xE3o de dom\xEDnio reflete a nota mais alta de uma avalia\xE7\xE3o avaliada.";

    case 'latest':
      return "Dom\xEDnio calculado pela Pontua\xE7\xE3o mais recente. A pontua\xE7\xE3o do dom\xEDnio reflete a nota da avalia\xE7\xE3o mais recente.";
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return "Ao alinhar para este " + artifactTypeName + " se o aluno pontuar acima de " + _percent_ptBR_number(masteryPercent) + " dom\xEDnio ser\xE1 alcan\xE7ado.";
};
