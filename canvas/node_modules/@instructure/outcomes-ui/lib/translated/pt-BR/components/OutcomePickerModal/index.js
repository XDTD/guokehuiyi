  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Cancelar"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Resultados anexados"))), _react.default.createElement(ModalBody, {
        padding: "0",
