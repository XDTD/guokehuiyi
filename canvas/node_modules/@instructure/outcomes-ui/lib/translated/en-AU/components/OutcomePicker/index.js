...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Selected outcomes:"), _react.default.createElement(_OutcomeTags.default, {
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "To add or create outcomes, visit the Canvas outcomes page.",
          heading: "There are no outcomes",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
