...
var _OutcomesService = _interopRequireDefault(require("../OutcomesService"));

/* eslint-disable promise/always-return */
describe('OutcomesService', function () {
  var host = 'http://outcomes.docker';
  var jwt = 'wonderland';
  var subject = new _OutcomesService.default();
  afterEach(function () {
    _fetchMock.default.restore();
  });

  var mockGet = function mockGet(path, response) {
    _fetchMock.default.getOnce(host + path, response);
  };
  ...
  describe('loadOutcomes', function () {
    it('resolves with normalized json on success', function () {
      ...
      return subject.loadOutcomes(host, jwt).then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(serverResponse.outcome_tree);
      });
    });
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/outcomes\/tree\?excludes\[\]=scoring_method&depth=2&context_uuid=alphabeta$/);
        return true;
      }, []);
    ...
    it('supports specifying roots', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/roots\[\]=4&roots\[\]=5/);
        return true;
      }, []);
    ...
    it('rejects on error', function () {
      ...
      return subject.loadOutcomes(host, jwt).catch(function (err) {
        (0, _chai.expect)(err).to.have.property('status', 500);
      });
    });
  });
  describe('getOutcome', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/outcomes\/1$/);
        return true;
      }, []);
    ...
    it('resolves with json on success', function () {
      ...
      return subject.getOutcome(host, jwt, '1').then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(outcome);
      });
    });
    it('rejects on error', function () {
  ...
  describe('getAlignments', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/alignment_sets\/foo\?includes=outcomes$/);
        return true;
      }, []);
    ...
    it('resolves with json on success', function () {
      ...
      return subject.getAlignments(host, jwt, 'baz').then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(alignments.alignment_set);
      });
    });
    it('rejects on error', function () {
  ...
  describe('getArtifact', function () {
    ...
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/artifact\?artifact_id=1&artifact_type=quizzes.quiz$/);
        return true;
      }, []);
    ...
    it('resolves with json on success', function () {
      ...
      return subject.getArtifact(host, jwt, artifact.artifact_type, artifact.artifact_id).then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(artifact.alignment_set);
      });
    });
    it('rejects on error', function () {
  ...
  describe('upsertArtifact', function () {
    it('posts data in correct format', function () {
      _fetchMock.default.postOnce(function (_url, opts) {
        var body = JSON.parse(opts.body);
        (0, _chai.expect)(body).to.deep.equal({
          artifact_type: 'type',
          artifact_id: 'id',
    ...
    it('resolves on success', function () {
      ...
      _fetchMock.default.postOnce('http://outcomes.docker/api/artifacts', {
        status: 201,
        body: (0, _objectSpread2.default)({}, response)
      });
      ...
      return subject.upsertArtifact(host, jwt, payload.artifactType, payload.artifactId, payload.contextUuid, payload.outcomeIds).then(function (result) {
        return (0, _chai.expect)(result).to.deep.equal(response.alignment_set);
      });
    });
    it('rejects on error', function () {
      _fetchMock.default.postOnce('http://outcomes.docker/api/artifacts', 500);

      return subject.upsertArtifact(host, jwt, 'type', 'id', 'context', [1, 2, 3]).catch(function (err) {
        return (0, _chai.expect)(err).to.have.property('status', 500);
      });
    });
    it('resolves with an empty guid when there are no outcomes', function () {
      ...
      return subject.upsertArtifact(host, jwt, payload.artifactType, payload.artifactId, payload.contextUuid, payload.outcomeIds).then(function (result) {
        return (0, _chai.expect)(result).to.deep.equal({
          guid: null
        });
      });
    });
  ...
  describe('createAlignmentSet', function () {
    it('posts data in correct format', function () {
      _fetchMock.default.postOnce(function (url, opts) {
        var body = JSON.parse(opts.body);
        (0, _chai.expect)(body).to.deep.equal({
          outcome_ids: [44, 99]
        });
    ...
    it('resolves on success', function () {
      _fetchMock.default.postOnce('http://outcomes.docker/api/alignment_sets', {
        status: 201,
        body: {
          alignment_set: {
            guid: 'foo'
    ...
    it('rejects on error', function () {
      _fetchMock.default.postOnce('http://outcomes.docker/api/alignment_sets', 500);
  ...
  describe('getOutcomeRollups', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/outcome_rollups\?artifact_id=21&artifact_type=quiz$/);
        return true;
      }, []);
    ...
    it('resolves with json on success', function () {
      ...
      _fetchMock.default.getOnce('http://outcomes.docker/api/outcome_rollups?artifact_id=16&artifact_type=quiz', rollups);

      return subject.getOutcomeRollups(host, jwt, 'quiz', 16).then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(rollups.outcome_rollups);
      });
    });
    it('rejects on error', function () {
      _fetchMock.default.getOnce('http://outcomes.docker/api/outcome_rollups?artifact_id=50&artifact_type=quiz', 400);

      return subject.getOutcomeRollups(host, jwt, 'quiz', 50).catch(function (err) {
        (0, _chai.expect)(err).to.have.property('status', 400);
      });
    });
  });
  describe('getOutcomeResults', function () {
    it('resolves with json on success', function () {
      ...
      _fetchMock.default.getOnce(/http:\/\/outcomes.docker\/api\/authoritative_results\?artifact_id=16&artifact_type=quiz&outcome_id=1985&user_uuid_list=.*/, results);

      return subject.getOutcomeResults(host, jwt, 'quiz', 16, 1985, userList).then(function (result) {
        (0, _chai.expect)(result).to.deep.equal(results.results);
      });
    });
    it('rejects on error', function () {
      _fetchMock.default.getOnce(/http:\/\/outcomes.docker\/api\/authoritative_results\?artifact_id=16&artifact_type=quiz&outcome_id=1985&user_uuid_list=.*/, 400);
  ...
  describe('getUsers', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/users\?artifact_id=21&artifact_type=quiz$/);
        return true;
      }, []);
    ...
    it('resolves with json and page info on success', function () {
      ...
      _fetchMock.default.getOnce('http://outcomes.docker/api/users?artifact_id=16&artifact_type=quiz&page=1', response);
    ...
    it('rejects on error', function () {
      _fetchMock.default.getOnce('http://outcomes.docker/api/users?artifact_id=16&artifact_type=quiz&page=1', 400);
  ...
  describe('getIndividualResults', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/individual_results\?artifact_id=21&artifact_type=quiz&includes\[\]=outcomes&includes\[\]=outcome_rollups&user_uuid=userId$/);
        return true;
      }, []);
    ...
    it('resolves with json and page info on success', function () {
      ...
      _fetchMock.default.getOnce('http://outcomes.docker/api/individual_results?artifact_id=21&artifact_type=quiz&includes[]=outcomes&includes[]=outcome_rollups&user_uuid=userId', response);
    ...
    it('rejects on error', function () {
      _fetchMock.default.getOnce('http://outcomes.docker/api/individual_results?artifact_id=21&artifact_type=quiz&includes[]=outcomes&includes[]=outcome_rollups&user_uuid=userId', 400);
  ...
  describe('getSearchResults', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        (0, _chai.expect)(url).to.match(/\/outcomes\/search\?context_uuid=def&page=999&text=abc$/);
        return true;
      }, []);
    ...
    it('resolves with json on success', function () {
      ...
      return subject.getSearchResults(host, jwt, 'abc', 999, 'def').then(function (result) {
        (0, _chai.expect)(result).to.deep.equal((0, _objectSpread2.default)({}, body, {
          total: 101
        }));
      });
    });
  ...
  describe('listOutcomes', function () {
    it('uses correct query', function () {
      _fetchMock.default.getOnce(function (url, opts) {
        ...
        (0, _chai.expect)(url).to.match(exp_url);
        return true;
      }, []);
