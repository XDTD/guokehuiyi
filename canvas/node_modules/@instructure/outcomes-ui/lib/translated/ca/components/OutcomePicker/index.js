...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Resultats seleccionats:"), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: "En aquest moment, no hi ha cap resultat seleccionat",
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "Per afegir o crear resultats, aneu a la p\xE0gina de resultats de Canvas.",
          heading: "No hi ha cap resultat",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
