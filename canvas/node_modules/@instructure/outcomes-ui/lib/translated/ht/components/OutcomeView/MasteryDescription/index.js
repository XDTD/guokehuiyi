...
var _percent_ht_number = Intl.NumberFormat("ht", { style: "percent" }).format,
    _default_ht_number = Intl.NumberFormat("ht", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return "Metriz kalkile pa Mway\xE8n Degradasyon Chif ki pi resan an t\xE8m de " + _percent_ht_number(scoringMethod.algorithm_data.decaying_average_percent) + " pwa metriz, mway\xE8n tout l\xF2t rezilta yo konsidere k\xF2m " + _percent_ht_number(1.0 - scoringMethod.algorithm_data.decaying_average_percent) + " pwa a. Si gen yon s\xE8l rezilta, s\xE8l grenn n\xF2t la ap retounen.";

    case 'n_mastery':
      return "Metriz kalkile pa n Kantite Fwa. Dwen gen metriz pou pi piti " + _default_ht_number(scoringMethod.algorithm_data.n_mastery_count) + " fwa.  N\xF2t ki depase metriz la ap kalkile an mway\xE8n pou yo ka kalkile n\xF2t final la,";

    case 'highest':
      return "Metriz kalkile ak N\xF2t ki pi Wo a. N\xF2t metriz la reflete pi wo n\xF2t yon evalyasyon grady\xE8l.";

    case 'latest':
      return "Metriz kalkile ak N\xF2t ki pi Resan an. N\xF2t metriz la reflete evalyasyon grady\xE8l ki pi resan an.";
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return "L\xE8 nou aliyen sou " + artifactTypeName + " sa a, si n\xF2t el\xE8v la depase " + _percent_ht_number(masteryPercent) + " l ap atenn metriz.";
};
