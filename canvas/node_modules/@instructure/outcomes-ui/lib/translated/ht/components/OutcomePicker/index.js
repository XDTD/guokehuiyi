...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Rezilta seleksyone:"), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: "Pa gen rezilta ki seleksyone pou kounye a",
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "Pou ajoute oswa kreye konklizyon, vizite paj konklizyon Canvas la.",
          heading: "Pa gen rezilta",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
