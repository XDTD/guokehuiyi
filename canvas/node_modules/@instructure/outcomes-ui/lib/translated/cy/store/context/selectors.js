...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_n === 1 ? _default_cy_number(count) + " Gr\u0175p" : _default_cy_number(count) + " Gr\u0175p");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_n2 === 1 ? _default_cy_number(count) + " Deilliant" : _default_cy_number(count) + " Deilliant");
};
