...
var _percent_cy_number = Intl.NumberFormat("cy", { style: "percent" }).format,
    _default_cy_number = Intl.NumberFormat("cy", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return "Wedi cyfrifo\u2019r lefel meistroli drwy Gyfartaledd sy\u2019n Edwino. Mae'r niferoedd mwyaf diweddar yn cyfrif fel " + _percent_cy_number(scoringMethod.algorithm_data.decaying_average_percent) + " o bwysiad y lefel meistroli, mae cyfartaledd yr holl ganlyniadau eraill yn cyfrif fel " + _percent_cy_number(1.0 - scoringMethod.algorithm_data.decaying_average_percent) + " o'r pwysiad. Os dim ond un canlyniad sydd, bydd un sg\xF4r yn cael ei chyflwyno.";

    case 'n_mastery':
      return "Wedi cyfrifo\u2019r lefel meistroli drwy n Nifer o Weithiau. Rhaid i chi gyrraedd y lefel meistroli o leiaf " + _default_cy_number(scoringMethod.algorithm_data.n_mastery_count) + " gwaith.  Bydd cymedr y sgoriau sy\u2019n uwch na lefel meistroli yn cael ei gyfrifo i roi sg\xF4r derfynol.";

    case 'highest':
      return "Lefel Meistrolaeth wedi\u2019i chyfrifo yn \xF4l Sg\xF4r Uchaf. Mae sg\xF4r meistroli yn adlewyrchu sg\xF4r uchaf aseiniad wedi'i raddio.";

    case 'latest':
      return "Lefel Meistroli wedi\u2019i chyfrifo yn \xF4l Sg\xF4r Ddiweddaraf. Mae sg\xF4r meistroli yn adlewyrchu\u2019r aseiniad wedi'i raddio mwyaf diweddar.";
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return "Drwy alinio \xE2'r " + artifactTypeName + " yma, os bydd y myfyriwr yn cael sg\xF4r uwch na " + _percent_cy_number(masteryPercent) + " bydd yn cyrraedd lefel meistroli.";
};
