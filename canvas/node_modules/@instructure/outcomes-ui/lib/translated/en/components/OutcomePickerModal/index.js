  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Cancel"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Attached Outcomes"))), _react.default.createElement(ModalBody, {
        padding: "0",
