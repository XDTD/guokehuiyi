...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Risultati selezionati:"), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: "Nessun risultato selezionato al momento",
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "Per aggiungere o creare risultati, visita la pagina dei risultati di Canvas.",
          heading: "Non ci sono risultati",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
