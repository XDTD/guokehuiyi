  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
      ...
      switch (this.props.outcomePickerState) {
        ...
        case 'choosing':
          if (this.props.anyOutcomeSelected) {
            return "Conferma gli allineamenti?";
          } else {
            return "Fine";
          }
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Annulla"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Risultati allegati"))), _react.default.createElement(ModalBody, {
        padding: "0",
