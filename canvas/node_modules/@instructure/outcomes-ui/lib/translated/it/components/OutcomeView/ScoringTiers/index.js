...
var _default_it_number = Intl.NumberFormat("it", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 studente" : _default_it_number(tier.count) + " studenti")))));
};
