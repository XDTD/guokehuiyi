...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_i2 = Math.floor(Math.abs(+_s)), 0 <= _i2 && _i2 <= 1 ? _default_pt_number(count) + " Grupo" : _default_pt_number(count) + " Grupos");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_i3 = Math.floor(Math.abs(+_s2)), 0 <= _i3 && _i3 <= 1 ? _default_pt_number(count) + " Resultados" : _default_pt_number(count) + " Resultados");
};
