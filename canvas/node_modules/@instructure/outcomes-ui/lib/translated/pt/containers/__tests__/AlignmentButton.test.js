...
describe('AlignmentButton', function () {
  ...
  it('renders', function () {
    var wrapper = (0, _enzyme.mount)(_react.default.createElement("div", {
      id: "app"
    }, _react.default.createElement(_AlignmentButton.default, makeProps())));
    (0, _chai.expect)(wrapper.find('AlignmentButton')).to.have.length(1);
  });
  it('sets the scope', function () {
    var props = makeProps();
    var wrapper = (0, _enzyme.mount)(_react.default.createElement("div", {
      id: "app"
    }, _react.default.createElement(_AlignmentButton.default, props)));
    (0, _chai.expect)(wrapper.find('AlignmentButton').prop('scope')).to.equal('foo:::1');
  });
