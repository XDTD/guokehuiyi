...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "Resultados selecionados"), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: "Atualmente, nenhum resultado est\xE1 selecionado",
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "Para adicionar ou criar resultados, visite a p\xE1gina de resultados do Canvas.",
          heading: "N\xE3o h\xE1 resultados",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
