...
var _default_pt_number = Intl.NumberFormat("pt", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), 0 <= _i && _i <= 1 ? "1 Aluno" : _default_pt_number(tier.count) + " Alunos")))));
};
