...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_i2 = Math.floor(Math.abs(+_s)), _i2 === 0 || _i2 === 1 ? _default_fr_number(count) + " Groupe" : _default_fr_number(count) + " Groupes");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_i3 = Math.floor(Math.abs(+_s2)), _i3 === 0 || _i3 === 1 ? _default_fr_number(count) + " R\xE9sultat" : _default_fr_number(count) + " R\xE9sultats");
};
