...
var _default_fr_number = Intl.NumberFormat("fr", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? "1 \xE9l\xE8ve" : _default_fr_number(tier.count) + " \xE9l\xE8ves")))));
};
