...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, "R\xE9sultats s\xE9lectionn\xE9s :"), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: "Aucun r\xE9sultat s\xE9lectionn\xE9 actuellement",
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: "Pour ajouter ou cr\xE9er des acquis, visitez la page des acquis Canvas.",
          heading: "Il n\u2019y a pas d'acquis.",
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
