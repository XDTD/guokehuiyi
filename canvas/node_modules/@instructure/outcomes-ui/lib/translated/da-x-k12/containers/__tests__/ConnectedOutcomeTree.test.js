...
describe('ConnectedOutcomeTree', function () {
  it('renders', function () {
    ...
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_reactRedux.Provider, {
      store: store
    }, _react.default.createElement(_ConnectedOutcomeTree.default, {
      contextUuid: "course_100",
      scope: "scopeForTest"
    })));
    (0, _chai.expect)(wrapper.find('OutcomeTree')).to.have.length(1);
  });
});