...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i2 = Math.floor(Math.abs(+_s)), _n === 1 || _t !== 0 && (_i2 === 0 || _i2 === 1) ? _default_daXK12_number(count) + " Gruppe" : _default_daXK12_number(count) + " grupper");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_t2 = +('' + _s2).replace(/^[^.]*.?|0+$/g, ''), _i3 = Math.floor(Math.abs(+_s2)), _n2 === 1 || _t2 !== 0 && (_i3 === 0 || _i3 === 1) ? _default_daXK12_number(count) + " L\xE6ringsudbytte" : _default_daXK12_number(count) + " L\xE6ringsudbytter");
};
