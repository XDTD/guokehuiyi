...
var _default_frCA_number = Intl.NumberFormat("fr-CA", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? "1 \xE9tudiant" : _default_frCA_number(tier.count) + " \xE9tudiants")))));
};
