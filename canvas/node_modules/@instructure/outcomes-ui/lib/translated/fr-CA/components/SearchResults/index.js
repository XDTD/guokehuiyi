...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("R\xE9sultats mis \xE0 jour pour la page " + searchPage + " de " + this.getPageCount());
          screenreaderNotification(this.getResultCountText());
        }

        if (!(0, _isEqual.default)(searchPage, prevProps.searchPage)) {
          screenreaderNotification("Chargement de la page " + searchPage);
        }
      }
    }
  }, {
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "La recherche n'a renvoy\xE9 aucun r\xE9sultat" : (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? _default_frCA_number(searchTotal) + " r\xE9sultat" : _default_frCA_number(searchTotal) + " r\xE9sultats");
    }
  }, {
    key: "renderResults",
    ...
    value: function renderLoading() {
      return _react.default.createElement(_uiFlex.Flex, {
        ...
        renderTitle: "Chargement des r\xE9sultats de recherche"
      })));
    }
  }, {
    key: "render",
