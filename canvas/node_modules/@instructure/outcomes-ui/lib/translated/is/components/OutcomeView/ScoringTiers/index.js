...
var _default_is_number = Intl.NumberFormat("is", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderTier = function renderTier(scoringMethod, tier) {
  ...
  return _react.default.createElement("div", {
    ...
    size: "small"
  }, (_s = tier.count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _t === 0 && _i % 10 === 1 && _i % 100 !== 11 || _t !== 0 ? "1 nemandi" : _default_is_number(tier.count) + " nemendur")))));
};
