  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
      ...
      switch (this.props.outcomePickerState) {
        ...
        case 'choosing':
          if (this.props.anyOutcomeSelected) {
            return "Afstemmingen bevestigen";
          } else {
            return "Gereed";
          }
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Annuleren"), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, "Bijgevoegde leerdoelen"))), _react.default.createElement(ModalBody, {
        padding: "0",
