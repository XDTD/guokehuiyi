...
var _percent_sl_number = Intl.NumberFormat("sl", { style: "percent" }).format,
    _default_sl_number = Intl.NumberFormat("sl", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return "Odli\u010Dnost, izra\u010Dunana z ute\u017Eeno povpre\u010Dno oceno Najnovej\u0161i \u0161teje kot " + _percent_sl_number(scoringMethod.algorithm_data.decaying_average_percent) + " ute\u017Ei odli\u010Dnosti, povpre\u010Dje vseh drugih rezultatov pa kot " + _percent_sl_number(1.0 - scoringMethod.algorithm_data.decaying_average_percent) + " ute\u017Ei. \u010Ce je rezultat samo en, bo vrnjena samo ena ocena.";

    case 'n_mastery':
      return "Odli\u010Dnost, izra\u010Dunana z n-kratnikom. Odli\u010Dnost mora dose\u010Di vsaj " + _default_sl_number(scoringMethod.algorithm_data.n_mastery_count) + "-krat.  Rezultati, ki presegajo odli\u010Dnost, bodo za izra\u010Dun kon\u010Dne ocene povpre\u010Deni.";

    case 'highest':
      return "Odli\u010Dnost, izra\u010Dunana z najvi\u0161jim rezultatom. Rezultat odli\u010Dnosti izra\u017Ea najvi\u0161ji rezultat ocenjevanja z ocenami.";

    case 'latest':
      return "Odli\u010Dnost, izra\u010Dunana glede na najnovej\u0161i rezultat. Rezultat odli\u010Dnosti izra\u017Ea najnovej\u0161e ocenjevanje z ocenami.";
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return "\u010Ce \u0161tudent dose\u017Ee rezultat, vi\u0161ji od " + _percent_sl_number(masteryPercent) + ", bo s poravnavo s tem " + artifactTypeName + " dose\u017Eeno napredovanje v odli\u010Dnosti.";
};
