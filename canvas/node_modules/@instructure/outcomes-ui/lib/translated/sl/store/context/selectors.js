...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_v = (_s + '.').split('.')[1].length, _i2 = Math.floor(Math.abs(+_s)), _v === 0 && _i2 % 100 === 1 ? _default_sl_number(count) + " skupina" : _default_sl_number(count) + " skupin");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_v2 = (_s2 + '.').split('.')[1].length, _i3 = Math.floor(Math.abs(+_s2)), _v2 === 0 && _i3 % 100 === 1 ? _default_sl_number(count) + " u\u010Dni izid" : _default_sl_number(count) + " u\u010Dnih izidov");
};
