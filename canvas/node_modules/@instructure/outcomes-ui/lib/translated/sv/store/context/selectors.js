...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_i2 = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i2 === 1 && _v === 0 ? _default_sv_number(count) + " grupp" : _default_sv_number(count) + " grupper");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_i3 = Math.floor(Math.abs(+_s2)), _v2 = (_s2 + '.').split('.')[1].length, _i3 === 1 && _v2 === 0 ? _default_sv_number(count) + " l\xE4randem\xE5l" : _default_sv_number(count) + " l\xE4randem\xE5l");
};
