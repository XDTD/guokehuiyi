...
var AlignmentButton = (_dec = (0, _uiThemeable.themeable)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$Component) {
  ...
  function AlignmentButton() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(AlignmentButton)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _this.renderHeader = function () {
      ...
      if (!readOnly || alignedOutcomes.length) {
        return _react.default.createElement("div", {
          ...
          className: styles.spacing
        }, (0, _formatMessage.default)('Aligned Outcomes'), " \xA0", _react.default.createElement(_AlignmentCount.default, {
    ...
    _this.renderButton = function () {
      ...
      if (!readOnly) {
        return _react.default.createElement("div", {
          ...
          alt: (0, _formatMessage.default)('Align Outcomes')
        }, (0, _formatMessage.default)('Outcome'))));
      }
    };
  ...
  (0, _createClass2.default)(AlignmentButton, [{
    ...
    value: function handleRemoveAlignment(removedOutcome, index) {
      ...
      this.props.screenreaderNotification((0, _formatMessage.default)('{label} alignment removed', {
        label: removedOutcome.label
      }));
