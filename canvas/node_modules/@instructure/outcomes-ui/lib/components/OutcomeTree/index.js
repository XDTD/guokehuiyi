...
var _OutcomeSelectionList = _interopRequireDefault(require("../OutcomeSelectionList"));

var _OutcomeFolderList = _interopRequireDefault(require("../OutcomeFolderList"));

var _TreeBrowser = _interopRequireDefault(require("./TreeBrowser"));
...
var AlignOutcomes = function AlignOutcomes(props) {
  ...
  }, props), _react.default.createElement("title", null, "Align-Outcomes"), _react.default.createElement("g", {
    fill: "none",
    fillRule: "evenodd"
...
var OutcomeTree = (_dec = (0, _uiThemeable.default)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(OutcomeTree, _React$Component);

  function OutcomeTree() {
    (0, _classCallCheck2.default)(this, OutcomeTree);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(OutcomeTree).apply(this, arguments));
  }

  (0, _createClass2.default)(OutcomeTree, [{
    key: "setRHS",
    ...
    value: function componentDidUpdate(oldProps) {
      ...
      var parent = _reactDom.default.findDOMNode(this); // eslint-disable-line react/no-find-dom-node
    ...
    value: function renderActiveCollection() {
      ...
      return activeCollection && activeCollection.id ? _react.default.createElement("div", {
        className: styles.selectedOutcomeCollection
      }, _react.default.createElement("div", null, _react.default.createElement(_uiHeading.Heading, {
        level: "h3",
        as: "h2",
        margin: "0 0 x-small"
      }, activeCollection.header)), _react.default.createElement("div", null, _react.default.createElement(_uiText.Text, {
        size: "x-small"
      }, activeCollection.summary)), _react.default.createElement(_uiText.Text, {
        size: "x-small"
      }, _react.default.createElement("div", {
        className: styles.outcomeDescription,
        dangerouslySetInnerHTML: {
          // eslint-disable-line react/no-danger
          __html: (0, _sanitize.sanitizeHtml)(activeCollection.description)
        }
      }))) : _react.default.createElement(_uiBillboard.Billboard, {
        message: (0, _formatMessage.default)('Browse your outcomes using the group folders.'),
        heading: (0, _formatMessage.default)('Align Outcomes'),
        headingAs: "h3",
        headingLevel: "h3",
        size: "small",
        hero: _react.default.createElement(AlignOutcomes, null),
        margin: "medium"
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_uiFlex.Flex, {
      ...
      }, _react.default.createElement(_TreeBrowser.default, {
        ...
        size: "0",
        shouldGrow: true
      }, this.renderActiveCollection(), _react.default.createElement(_OutcomeSelectionList.default, {
      ...
      }), _react.default.createElement(_OutcomeFolderList.default, {
        outcomes: groups,
        setActiveCollection: setActiveCollection,
  ...
  activeChildren: _propTypes.default.shape({
    groups: _propTypes.default.array,
    nonGroups: _propTypes.default.array
  }),
  activeCollection: _propTypes.default.shape({
