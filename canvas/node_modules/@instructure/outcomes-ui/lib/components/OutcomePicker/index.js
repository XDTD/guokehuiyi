...
var OutcomePicker = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(OutcomePicker, [{
    ...
    value: function renderHeader() {
      ...
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, (0, _formatMessage.default)('Selected outcomes:')), _react.default.createElement(_OutcomeTags.default, {
        outcomes: selectedOutcomes,
        emptyText: (0, _formatMessage.default)('No Outcomes are currently selected'),
        deselectOutcomeIds: deselectOutcomeIds
    ...
    value: function render() {
      ...
      if (!hasOutcomes) {
        return _react.default.createElement(_uiBillboard.Billboard, {
          message: (0, _formatMessage.default)('To add or create outcomes, visit the Canvas outcomes page.'),
          heading: (0, _formatMessage.default)('There are no outcomes'),
          headingAs: "h3",
          headingLevel: "h3",
          size: "small",
