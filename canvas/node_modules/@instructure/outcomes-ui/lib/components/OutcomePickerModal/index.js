  ...
  (0, _createClass2.default)(OutcomePickerModal, [{
      ...
      switch (this.props.outcomePickerState) {
        ...
        case 'choosing':
          if (this.props.anyOutcomeSelected) {
            return (0, _formatMessage.default)('Confirm Alignments');
          } else {
            return (0, _formatMessage.default)('Done');
          }

        case 'saving':
        case 'complete':
        default:
          return (0, _formatMessage.default)('OK');
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement("span", null, _react.default.createElement(_uiModal.Modal, {
        ...
        transition: "fade",
        size: "fullscreen",
        label: (0, _formatMessage.default)('Align Outcomes'),
        zIndex: "9998",
        ...
        placement: "end",
        variant: "icon"
      }, (0, _formatMessage.default)('Cancel')), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
        size: "large"
      }, (0, _formatMessage.default)('Attached Outcomes')))), _react.default.createElement(ModalBody, {
        padding: "0",
      ...
      }, (0, _formatMessage.default)('Cancel')), _react.default.createElement(_uiButtons.Button, {
        margin: "xxx-small",
        onClick: function onClick() {
