...
var OutcomeViewModal = function OutcomeViewModal(props) {
  ...
  return _react.default.createElement(_uiModal.Modal, {
    ...
    transition: "fade",
    size: "fullscreen",
    label: (0, _formatMessage.default)('Outcome'),
    zIndex: "9999",
  ...
  }, (0, _formatMessage.default)('Close')), _react.default.createElement(_uiHeading.Heading, null, _react.default.createElement(_uiText.Text, {
    size: "large",
    "data-automation": "outcomeView__header"
  }, header || (0, _formatMessage.default)('View Outcome')))), _react.default.createElement(ModalBody, {
    padding: "none"
