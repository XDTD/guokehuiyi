...
var noOutcomes = function noOutcomes() {
  return {
    heading: (0, _formatMessage.default)('There is no report here to show'),
    message: (0, _formatMessage.default)('The assessment has no outcomes aligned to it. Go to the Build tab to align outcomes.'),
...
var noStudents = function noStudents() {
  return {
    heading: (0, _formatMessage.default)("Looks like you're a little early"),
    message: (0, _formatMessage.default)('Students must finish the assessment before any outcome results will show here. ' + 'Check back here after some students have completed the assessment.'),
    hero: _react.default.createElement(Early, null)
  };
};

var renderCorner = function renderCorner(count) {
  var text = (0, _formatMessage.default)("{\n    count, plural,\n        one {1 Outcome Aligned}\n      other {# Outcomes Aligned}\n  }", {
    count: count
  });
  return _react.default.createElement("div", {
  ...
  (0, _createClass2.default)(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return _react.default.createElement("div", {
        ...
        role: "rowheader"
      }, _react.default.createElement(_uiA11yContent.ScreenReaderContent, null, (0, _formatMessage.default)('Details'))), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          _react.default.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
