...
var noStudents = function noStudents() {
  return {
    ...
    message: t('Students must finish the assessment before any outcome results will show here. ' + 'Check back here after some students have completed the assessment.'),
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, t('Details'))), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
