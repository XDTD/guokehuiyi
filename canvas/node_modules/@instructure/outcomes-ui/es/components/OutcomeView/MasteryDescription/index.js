...
var scoringText = function scoringText(scoringMethod) {
  switch (scoringMethod.algorithm) {
    case 'decaying_average':
      return t('Mastery calculated by Decaying Average. Most recent counts as ' + '{recent_percent, number, percent} of mastery weight, average of all ' + 'other results count as {remain_percent, number, percent} of weight. ' + 'If there is only one result, the single score will be returned.', {
    ...
    case 'n_mastery':
      return t('Mastery calculated by n Number of Times. Must achieve mastery at ' + 'least {n_times, number} times.  Scores above mastery will be ' + 'averaged to calculate final score.', {
...
var masteryText = function masteryText(masteryPercent, artifactTypeName) {
  return t('By aligning to this {artifact_type_name} if the student scores above' + ' {mastery_percent, number, percent} mastery will be achieved.', {
