...
var noOutcomes = function noOutcomes() {
  return {
    heading: "\u6B64\u8655\u6C92\u6709\u53EF\u986F\u793A\u7684\u5831\u544A",
    message: "\u8A55\u4F30\u6C92\u6709\u8207\u4E4B\u76F8\u7B26\u7684\u5B78\u7FD2\u6210\u679C\u3002\u8ACB\u81F3\u914D\u7F6E\u6A19\u7C64\u914D\u5C0D\u5B78\u7FD2\u6210\u679C\u3002",
...
var noStudents = function noStudents() {
  return {
    heading: "\u60A8\u4F3C\u4E4E\u592A\u65E9\u4E86",
    message: "\u5B78\u751F\u9808\u5148\u5B8C\u6210\u8A55\u4F30\uFF0C\u624D\u80FD\u5728\u6B64\u8655\u986F\u793A\u5B78\u7FD2\u6210\u679C\u7D50\u679C\u3002\u8ACB\u5F85\u90E8\u5206\u5B78\u751F\u5DF2\u5B8C\u6210\u8A55\u4F30\u5F8C\uFF0C\u518D\u8FD4\u56DE\u6B64\u8655\u67E5\u770B\u3002",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = _default_zhHant_number(count) + " \u5DF2\u5C0D\u9F4A \u9805\u5B78\u7FD2\u6210\u679C";
  return React.createElement("div", {
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "\u8A73\u7D30\u8CC7\u6599")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
