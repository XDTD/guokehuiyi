...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_n === 1 ? _default_nbXK12_number(count) + " Gruppe" : _default_nbXK12_number(count) + " Grupper");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_n2 === 1 ? _default_nbXK12_number(count) + " M\xE5l" : _default_nbXK12_number(count) + " M\xE5l");
};
