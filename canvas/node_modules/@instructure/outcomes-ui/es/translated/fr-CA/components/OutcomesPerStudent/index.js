...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Aucun rapport disponible",
    message: "L\u2019\xE9valuation ne comporte aucun acquis. Allez \xE0 l\u2019onglet \xAB\xA0Construire\xA0\xBB (Build) pour harmoniser les acquis.",
...
var noStudents = function noStudents() {
  return {
    heading: "Il semblerait que vous soyez un peu t\xF4t",
    message: "Les \xE9tudiants doivent terminer l\u2019\xE9valuation avant que tout r\xE9sultat d\u2019acquis soit affich\xE9 ici. V\xE9rifier ici apr\xE8s que quelques \xE9tudiants ont compl\xE9t\xE9 l\u2019\xE9valuation.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? "1 acquis align\xE9" : _default_frCA_number(count) + " acquis align\xE9s"));
  return React.createElement("div", {
