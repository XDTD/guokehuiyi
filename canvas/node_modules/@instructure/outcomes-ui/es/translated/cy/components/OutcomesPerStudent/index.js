...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Wrthi\u2019n llwytho"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Does dim adroddiad i\u2019w ddangos yma",
    message: "Does dim deilliannau wedi\u2019u cysoni \xE2'r asesiad. Ewch i'r tab Adeiladu i gysoni deilliannau.",
...
var noStudents = function noStudents() {
  return {
    heading: "Rydych chi braidd yn fuan",
    message: "Rhaid i fyfyrwyr orffen yr aseiniad hwn cyn bydd canlyniadau deilliannau yn dangos yma. Dewch yn \xF4l yma i weld ar \xF4l i rai myfyrwyr gwblhau\u2019r asesiad.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_n === 1 ? "1 Deilliant wedi\u2019i Gysoni" : _default_cy_number(count) + " Deilliant wedi\u2019i Gysoni"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Tudalen Nesaf",
      labelPrev: "Tudalen Flaenorol"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Manylion")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
