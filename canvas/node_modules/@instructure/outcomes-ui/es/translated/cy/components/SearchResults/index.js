...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("Canlyniadau wedi\u2019u diweddaru ar gyfer tudalen " + searchPage + " o " + this.getPageCount());
          screenreaderNotification(this.getResultCountText());
        }

        if (!isEqual(searchPage, prevProps.searchPage)) {
          screenreaderNotification("Wrthi\u2019n llwytho tudalen " + searchPage);
        }
      }
    }
  }, {
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "Mae\u2019r broses chwilio wedi methu dod o hyd i unrhyw ganlyniadau" : (_n === 1 ? _default_cy_number(searchTotal) + " canlyniad" : _default_cy_number(searchTotal) + " canlyniad");
    }
  }, {
    key: "renderResults",
    ...
    value: function renderLoading() {
      return React.createElement(Flex, {
        ...
        renderTitle: "Wrthi\u2019n llwytho canlyniadau chwilio"
      })));
    }
  }, {
    key: "render",
