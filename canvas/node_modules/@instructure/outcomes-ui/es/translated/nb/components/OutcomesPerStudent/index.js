...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Her er det ingen rapport \xE5 vise",
    message: "Vurderingen har ingen l\xE6ringsm\xE5l justert til seg. G\xE5 til fanen for Bygg for \xE5 justere resultater.",
...
var noStudents = function noStudents() {
  return {
    heading: "Det ser ut til at du er litt tidlig ute",
    message: "Studentene m\xE5 fullf\xF8re vurderingen f\xF8r resultatene for l\xE6ringsm\xE5l vil vises her. Sjekk her etter at studenter har fullf\xF8rt vurderingen.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_n === 1 ? "1 justert l\xE6ringsm\xE5l" : _default_nb_number(count) + " justerte l\xE6ringsm\xE5l"));
  return React.createElement("div", {
