...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("Ni\xF0urst\xF6\xF0ur uppf\xE6r\xF0ar fyrir s\xED\xF0u " + searchPage + " af " + this.getPageCount());
          screenreaderNotification(this.getResultCountText());
        }

        if (!isEqual(searchPage, prevProps.searchPage)) {
          screenreaderNotification("Hle\xF0 inn s\xED\xF0u " + searchPage);
        }
      }
    }
  }, {
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "Leitin skila\xF0i engum ni\xF0urst\xF6\xF0um" : (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _t === 0 && _i % 10 === 1 && _i % 100 !== 11 || _t !== 0 ? _default_is_number(searchTotal) + " ni\xF0urst\xF6\xF0u" : _default_is_number(searchTotal) + " ni\xF0urst\xF6\xF0um");
    }
  }, {
    key: "renderResults",
    ...
    value: function renderLoading() {
      return React.createElement(Flex, {
        ...
        renderTitle: "Hle\xF0 inn leitarni\xF0urst\xF6\xF0um"
      })));
    }
  }, {
    key: "render",
