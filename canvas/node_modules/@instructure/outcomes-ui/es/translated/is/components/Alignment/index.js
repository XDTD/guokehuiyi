...
var Alignment = (_dec = themeable(theme, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Alignment, [{
    ...
    value: function render() {
      ...
      var removeMessage = "Fjarl\xE6gja " + outcome.title;
      return React.createElement("li", {
        ...
        size: "large"
      }, React.createElement(IconOutcomesLine, null))), React.createElement("span", {
        ...
        weight: "bold"
      }, outcome.title)))))), !readOnly && React.createElement("span", {
        className: styles.delete,
        "data-automation": "alignment-delete"
      }, React.createElement(Button, {
        variant: "icon",
        onClick: removeAlignment
      }, React.createElement(IconTrashLine, {
        title: removeMessage
