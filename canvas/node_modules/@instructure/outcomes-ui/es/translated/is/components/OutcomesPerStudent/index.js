...
var Early = function Early(props) {
  ...
  }, props), React.createElement("title", null, "Early-Graphic"), React.createElement("g", {
    fill: "none",
    fillRule: "evenodd"
...
var renderBillboard = function renderBillboard(args, _foo) {
  ...
  return React.createElement(Billboard, boardProps);
};
...
var noOutcomes = function noOutcomes() {
  return {
    heading: "\xDEa\xF0 er engin sk\xFDrsla til a\xF0 s\xFDna",
    message: "\xDEetta mat hefur engar ni\xF0urst\xF6\xF0ur jafna\xF0ar vi\xF0 \xFEa\xF0. Far\xF0u \xED byggja flipann til a\xF0 jafna ni\xF0urst\xF6\xF0ur.",
    hero: React.createElement("span", {
      "aria-hidden": "true"
    }, React.createElement(NoReport, null))
  };
};

var noStudents = function noStudents() {
  return {
    heading: "\xDE\xFA vir\xF0ist vera svol\xEDti\xF0 snemma \xE1 \xFEv\xED",
    message: "Nemendur ver\xF0a a\xF0 lj\xFAka mati \xE1\xF0ur en nokkrar ni\xF0urst\xF6\xF0ur ver\xF0a s\xFDndar h\xE9r. Komdu aftur eftir a\xF0 einhverjir nemendur hafa loki\xF0 matinu.",
    hero: React.createElement(Early, null)
  };
};
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _t === 0 && _i % 10 === 1 && _i % 100 !== 11 || _t !== 0 ? "1 ni\xF0ursta\xF0a j\xF6fnu\xF0" : _default_is_number(count) + " ni\xF0urst\xF6\xF0ur jafna\xF0ar"));
  return React.createElement("div", {
...
var renderStudentName = function renderStudentName(student) {
  var studentNameId = shortid.generate();
  var studentNameElement = React.createElement("div", {
    className: styles.studentName,
    id: studentNameId,
    role: "rowheader"
  }, React.createElement(PresentationContent, null, React.createElement("span", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "N\xE6sta s\xED\xF0a",
      labelPrev: "Fyrri s\xED\xF0a"
    }, _.range(1, pageCount + 1).map(function (pageNumber) {
...
var OutcomesPerStudentReport = (_dec = themeable(theme, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$Component) {
  _inherits(OutcomesPerStudentReport, _React$Component);

  function OutcomesPerStudentReport() {
    _classCallCheck(this, OutcomesPerStudentReport);

    return _possibleConstructorReturn(this, _getPrototypeOf(OutcomesPerStudentReport).apply(this, arguments));
  }

  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Uppl\xFDsingar")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
          }, React.createElement(ScreenReaderContent, null, React.createElement(HeaderDetails, {
            outcomeResult: rollup,
            showRollups: showRollups
          })))
        );
