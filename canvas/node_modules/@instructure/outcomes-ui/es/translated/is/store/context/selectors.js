...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i2 = Math.floor(Math.abs(+_s)), _t === 0 && _i2 % 10 === 1 && _i2 % 100 !== 11 || _t !== 0 ? _default_is_number(count) + " h\xF3pur" : _default_is_number(count) + " h\xF3par");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_t2 = +('' + _s2).replace(/^[^.]*.?|0+$/g, ''), _i3 = Math.floor(Math.abs(+_s2)), _t2 === 0 && _i3 % 10 === 1 && _i3 % 100 !== 11 || _t2 !== 0 ? _default_is_number(count) + " ni\xF0ursta\xF0a" : _default_is_number(count) + " ni\xF0urst\xF6\xF0ur");
};
