...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "S\xF8gningen gav ingen resultater" : (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _n === 1 || _t !== 0 && (_i === 0 || _i === 1) ? _default_da_number(searchTotal) + " resultat" : _default_da_number(searchTotal) + " resultater");
    }
  }, {
    key: "renderResults",
