...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Indl\xE6ser"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Der er ingen rapport her, der skal vises",
    message: "Vurderingen har ingen l\xE6ringsudbytter tilpasset til den. G\xE5 til fanen Byg for at tilknytte l\xE6ringsudbytter.",
...
var noStudents = function noStudents() {
  return {
    heading: "Det ser ud til, du er lidt tidligt",
    message: "Studerende skal afslutte vurderingen, f\xF8r resultaterne vises her. Kom tilbage, n\xE5r nogle studerende har gennemf\xF8rt vurderingen.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _n === 1 || _t !== 0 && (_i === 0 || _i === 1) ? "1 L\xE6ringsudbytte tilpasset" : _default_da_number(count) + " L\xE6ringsudbytter tilpasset"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "N\xE6ste side",
      labelPrev: "Forrige side"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "N\xE6rmere oplysninger")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
