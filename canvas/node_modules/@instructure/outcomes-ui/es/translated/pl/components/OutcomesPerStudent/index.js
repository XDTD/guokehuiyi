...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Wczytywanie"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Brak raportu do wy\u015Bwietlenia",
    message: "Brak wynik\xF3w powi\u0105zanych z tym testem. Przejd\u017A do karty tworzenia, aby powi\u0105za\u0107 wyniki.",
...
var noStudents = function noStudents() {
  return {
    heading: "Wygl\u0105da na to, \u017Ce jeste\u015B tu za wcze\u015Bnie",
    message: "Aby wyniki zosta\u0142y tu wy\u015Bwietlone, uczestnicy musz\u0105 uko\u0144czy\u0107 test. Powr\xF3\u0107 tu, gdy niekt\xF3rzy uczestnicy uko\u0144cz\u0105 test.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 wynik dostosowany" : _default_pl_number(count) + " wynik\xF3w dostosowano"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Nast\u0119pna strona",
      labelPrev: "Poprzednia strona"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Szczeg\xF3\u0142y")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
