...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("Ergebnisse f\xFCr Seite " + searchPage + " von " + this.getPageCount() + " aktualisiert");
          screenreaderNotification(this.getResultCountText());
        }

        if (!isEqual(searchPage, prevProps.searchPage)) {
          screenreaderNotification("Seite " + searchPage + " wird geladen");
        }
      }
    }
  }, {
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "Die Suche ergab keine Ergebnisse" : (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? _default_de_number(searchTotal) + " Ergebnis" : _default_de_number(searchTotal) + " Ergebnisse");
    }
  }, {
    key: "renderResults",
    ...
    value: function renderLoading() {
      return React.createElement(Flex, {
        ...
        renderTitle: "Suchergebnisse werden geladen"
      })));
    }
  }, {
    key: "render",
