...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Wird geladen"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Es gibt hier keinen Bericht.",
    message: "An der Bewertung sind keine Lernziele ausgerichtet. Gehen Sie auf die Registerkarte \u201EBauen\u201C, um Lernziele auszurichten.",
...
var noStudents = function noStudents() {
  return {
    heading: "Sieht aus, als w\xE4ren Sie etwas zu fr\xFCh.",
    message: "Die Studenten m\xFCssen den die Bewertung beendet haben, bevor hier Lernzielergebnisse angezeigt werden. Schauen Sie hier nach, nachdem einige Studenten den Quiz abgeschlossen haben.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1\xA0Lernziel angepasst" : _default_de_number(count) + "\xA0Lernziele angepasst"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "N\xE4chste Seite",
      labelPrev: "Vorherige Seite"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Details")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
