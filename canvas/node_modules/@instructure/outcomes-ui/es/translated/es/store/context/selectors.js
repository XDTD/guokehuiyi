...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_n === 1 ? _default_es_number(count) + " grupo" : _default_es_number(count) + " grupos");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_n2 === 1 ? _default_es_number(count) + "Competencia" : _default_es_number(count) + "Competencias");
};
