...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Cargando"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "No hay ning\xFAn reporte aqu\xED para mostrar",
    message: "La evaluaci\xF3n no tiene competencias alineadas. Ingrese a la pesta\xF1a Construcci\xF3n para alinear las competencias.",
...
var noStudents = function noStudents() {
  return {
    heading: "Parece que es muy pronto",
    message: "Los estudiantes deben terminar primero la evaluaci\xF3n para que se muestren los resultados de competencia aqu\xED. Vuelva a intentarlo despu\xE9s de que algunos estudiantes hayan completado la evaluaci\xF3n.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_n === 1 ? "1\xA0competencia alineada" : _default_es_number(count) + " competencias alineadas"));
  return React.createElement("div", {
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Detalles")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
