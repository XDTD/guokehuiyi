...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Aqu\xED no hi ha cap informe per mostrar",
    message: "L'avaluaci\xF3 no t\xE9 cap resultat alineat. Aneu a la pestanya Construeix per alinear els resultats.",
...
var noStudents = function noStudents() {
  return {
    heading: "Sembla que aneu una mica avan\xE7at",
    message: "Els estudiants han d'acabar l'avaluaci\xF3 abans que els resultats es mostrin aqu\xED. Torneu a comprovar-ho aqu\xED despr\xE9s que alguns estudiants hagin finalitzat l'avaluaci\xF3.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1\xA0resultat alineat" : _default_ca_number(count) + " resultats alineats"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "P\xE0gina seg\xFCent",
      labelPrev: "P\xE0gina anterior"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Detalls")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
