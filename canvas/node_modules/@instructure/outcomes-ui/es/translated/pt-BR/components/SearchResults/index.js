...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("Resultados atualizados para a p\xE1gina " + searchPage + " de " + this.getPageCount());
          screenreaderNotification(this.getResultCountText());
        }

        if (!isEqual(searchPage, prevProps.searchPage)) {
          screenreaderNotification("Carregando a p\xE1gina " + searchPage);
        }
      }
    }
  }, {
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "A pesquisa n\xE3o retornou resultados" : (_i = Math.floor(Math.abs(+_s)), 0 <= _i && _i <= 1 ? _default_ptBR_number(searchTotal) + " resultado" : _default_ptBR_number(searchTotal) + " resultados");
    }
  }, {
    key: "renderResults",
    ...
    value: function renderLoading() {
      return React.createElement(Flex, {
        ...
        renderTitle: "Carregando resultados de pesquisa"
      })));
    }
  }, {
    key: "render",
