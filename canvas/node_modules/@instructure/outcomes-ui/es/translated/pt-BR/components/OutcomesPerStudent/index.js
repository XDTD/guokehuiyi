...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Carregando"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "N\xE3o h\xE1 nenhum resultado aqui para mostrar",
    message: "A avalia\xE7\xE3o n\xE3o tem resultados alinhados a ela. V\xE1 at\xE9 a aba Construir para alinhar resultados.",
...
var noStudents = function noStudents() {
  return {
    ...
    message: "Alunos devem terminar a avalia\xE7\xE3o antes de quaisquer resultados serem exibidos aqui. Verifique novamente aqui ap\xF3s alguns alunos terem conclu\xEDdo a avalia\xE7\xE3o.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), 0 <= _i && _i <= 1 ? "1 Resultado alinhado" : _default_ptBR_number(count) + " Resultados alinhados"));
  return React.createElement("div", {
