...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Pa gen rap\xF2 la a pou afiche",
    message: "Evalyasyon an pa gen konklizyon ki adapte av\xE8k li. Ale nan ongl\xE8 Konstriksyon an pou aliyen rezilta yo.",
...
var noStudents = function noStudents() {
  return {
    heading: "Sanble w tw\xF2 prese",
    message: "El\xE8v yo dwe fini evalyasyon an anvan konklizyon rezilta yo afiche la a. Retounen gade la a apr\xE8 k\xE8k el\xE8v fini evalyasyon an.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = _default_ht_number(count) + " Rezilta Aliyen";
  return React.createElement("div", {
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Detay")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
