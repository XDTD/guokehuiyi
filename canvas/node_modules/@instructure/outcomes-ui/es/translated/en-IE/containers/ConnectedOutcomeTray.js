...
import { getFocusedOutcome, getSelectedOutcomeIds, getOutcomePickerState, makeIsOutcomeSelected } from '../store/OutcomePicker/selectors';
import { getOutcomeList, getListPage, getListTotal } from '../store/OutcomeTray/selectors';
...
function mapDispatchToProps(dispatch, ownProps) {
  ...
  return _objectSpread({}, bindScopedActionCreators(outcomePickerActions, dispatch, scope), {}, bindScopedActionCreators(activePickerActions, dispatch), {}, bindScopedActionCreators(contextActions, dispatch, scope), {}, bindScopedActionCreators(searchActions, dispatch, scope), {}, bindScopedActionCreators(trayActions, dispatch, scope), {
