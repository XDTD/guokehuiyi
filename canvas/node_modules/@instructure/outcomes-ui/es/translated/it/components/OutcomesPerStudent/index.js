...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Nessun report qui da mostrare",
    message: "Nessun risultato allineato alla valutazione. Vai alla scheda Crea per allineare i risultati.",
...
var noStudents = function noStudents() {
  return {
    heading: "Sembra che tu sia in anticipo",
    message: "I risultati verranno visualizzati qui solo dopo che gli studenti hanno completato la valutazione. Controlla di nuovo dopo che alcuni studenti hanno completato la valutazione.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 risultato allineato" : _default_it_number(count) + " risultati allineati"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Pagina successiva",
      labelPrev: "Pagina precedente"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Dettagli")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
