...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Nalaganje"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Ni nobenega poro\u010Dila za prikaz.",
    message: "Z ocenjevanjem ni poravnan noben u\u010Dni izid. Za poravnavo u\u010Dnih izidov pojdite na zavihek \xBBPripravi\xAB.",
...
var noStudents = function noStudents() {
  return {
    heading: "Zdi se, da ste nekoliko prezgodnji.",
    message: "\u0160tudenti morajo dokon\u010Dati ocenjevanje, preden bodo tu prikazani morebitni rezultati izida. Ko nekaj \u0161tudentov zaklju\u010Di ocenjevanje, spet preverite tukaj.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_v = (_s + '.').split('.')[1].length, _i = Math.floor(Math.abs(+_s)), _v === 0 && _i % 100 === 1 ? "1 u\u010Dni izid je poravnan." : _default_sl_number(count) + " u\u010Dnih izidov je poravnanih."));
  return React.createElement("div", {
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Podrobnosti")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
