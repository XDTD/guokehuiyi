...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "A carregar"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "N\xE3o existe relat\xF3rio aqui pra mostrar",
    message: "A avalia\xE7\xE3o n\xE3o tem resultados alinhados a ela. V\xE1 ao separador Construir para alinhar resultados.",
...
var noStudents = function noStudents() {
  return {
    heading: "Parece que voc\xEA est\xE1 um pouco adiantado",
    message: "Os alunos devem terminar a avalia\xE7\xE3o antes que os resultados dos resultados sejam apresentados aqui. Volte aqui depois que alguns alunos conclu\xEDram a avalia\xE7\xE3o.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), 0 <= _i && _i <= 1 ? "1 Resultado Alinhado" : _default_pt_number(count) + " Resultados Alinhados"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Pr\xF3xima p\xE1gina",
      labelPrev: "P\xE1gina anterior"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Detalhes")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
