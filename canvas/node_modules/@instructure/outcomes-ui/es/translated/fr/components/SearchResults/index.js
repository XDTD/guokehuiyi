...
var SearchResults = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (screenreaderNotification) {
        if (!isSearchLoading && prevProps.isSearchLoading) {
          screenreaderNotification("R\xE9sultats mis \xE0 jour pour la page " + searchPage + " sur " + this.getPageCount());
    ...
    value: function getResultCountText() {
      ...
      var searchTotal = this.props.searchTotal;
      return _s = searchTotal, _n = +_s, _n === 0 ? "La recherche n'a donn\xE9 aucun r\xE9sultat" : (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? _default_fr_number(searchTotal) + " r\xE9sultat" : _default_fr_number(searchTotal) + " r\xE9sultats");
    }
  }, {
    key: "renderResults",
