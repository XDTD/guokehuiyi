...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Il n'y a aucun rapport \xE0 afficher ici",
    message: "Cette \xE9valuation n'a pas d'acquis li\xE9. Acc\xE9dez \xE0 l'onglet Construire pour aligner les r\xE9sultats.",
...
var noStudents = function noStudents() {
  return {
    heading: "Il semblerait que vous soyez un peu en avance",
    message: "Les \xE9l\xE8ves doivent terminer l\u2019\xE9valuation avant que des r\xE9sultats d'acquis ne s'affichent ici. Revenez voir \xE0 cet endroit lorsque des \xE9l\xE8ves auront termin\xE9 l\u2019\xE9valuation.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _i === 0 || _i === 1 ? "1 r\xE9sultat align\xE9" : _default_fr_number(count) + " r\xE9sultats align\xE9s"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      ...
      labelPrev: "Page pr\xE9c\xE9dente"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "D\xE9tails")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
