...
describe('TreeBrowser', function () {
  ...
  it('renders a TreeBrowser component', function () {
    var wrapper = mount(React.createElement(TreeBrowser, makeProps()));
  ...
  it('meets a11y standards', function () {
    return checkA11y(React.createElement(TreeBrowser, makeProps()));
  });
});