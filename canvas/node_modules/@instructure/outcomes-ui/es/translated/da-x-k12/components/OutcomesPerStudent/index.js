...
var noStudents = function noStudents() {
  return {
    ...
    message: "Elever skal afslutte vurderingen, f\xF8r resultaterne vises her. Kom tilbage, n\xE5r nogle elever har gennemf\xF8rt vurderingen.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_t = +('' + _s).replace(/^[^.]*.?|0+$/g, ''), _i = Math.floor(Math.abs(+_s)), _n === 1 || _t !== 0 && (_i === 0 || _i === 1) ? "1 L\xE6ringsudbytte tilpasset" : _default_daXK12_number(count) + " L\xE6ringsudbytter tilpasset"));
  return React.createElement("div", {
