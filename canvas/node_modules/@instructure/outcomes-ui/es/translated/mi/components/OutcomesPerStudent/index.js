...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Kaore he r\u012Bpoata i konei hei whak\u0101tu",
    message: "Kaore he putanga o te aromatawai e hangai ana ki ia. Haere ki te Hanga ripa ki te whakap\u0101 ki ng\u0101 putanga",
...
var noStudents = function noStudents() {
  return {
    heading: "E tiro ana he \u0101hua wawe iti  koe",
    message: "Me whakaoti e ng\u0101 akonga te aromatawai i mua i te whak\u0101tu mai o ng\u0101 huanga i konei. Whakahoki mai ki konei i muri i te whakaoti o te aromatawai i \u0113tahi o ng\u0101 akonga.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = _default_mi_number(count) + " Ng\u0101 putanga kei te h\u0101ngai";
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Wh\u0101rangi haere ake nei",
      labelPrev: "Te wh\u0101rangi o muri nei"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Ng\u0101 taipitopito")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
