  ...
  _createClass(OutcomePickerModal, [{
    ...
    value: function render() {
      ...
      return React.createElement("span", null, React.createElement(Modal, {
        ...
        placement: "end",
        variant: "icon"
      }, "Whakakore"), React.createElement(Heading, null, React.createElement(Text, {
        size: "large"
      }, "Ng\u0101 putanga kua t\u0101piritia"))), React.createElement(ModalBody, {
        padding: "0",
      ...
      }, "Whakakore"), React.createElement(Button, {
        margin: "xxx-small",
        onClick: function onClick() {
