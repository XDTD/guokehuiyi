...
var noOutcomes = function noOutcomes() {
  return {
    heading: "There is no report here to show",
    message: "The assessment has no outcomes aligned to it. Go to the Build tab to align outcomes.",
...
var noStudents = function noStudents() {
  return {
    heading: "Looks like you're a little early",
    message: "Students must finish the assessment before any outcome results will show here. Check back here after some students have completed the assessment.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 Outcome Aligned" : _default_enAUXUnimelb_number(count) + " Outcomes Aligned"));
  return React.createElement("div", {
