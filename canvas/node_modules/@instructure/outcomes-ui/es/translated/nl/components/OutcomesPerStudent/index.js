...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Bezig met laden..."
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Er zijn hier geen rapporten die kunnen worden weergegeven",
    message: "Aan de beoordeling zijn geen leerdoelen gekoppeld. Ga naar het tabblad Bouwen om leerdoelen te koppelen.",
...
var noStudents = function noStudents() {
  return {
    heading: "Het lijkt erop dat je wat te vroeg bent",
    message: "Cursisten moeten de beoordeling voltooien voordat hier resultaten worden weergegeven. Kom hier terug nadat enkele cursisten de beoordeling hebben voltooid.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 leerdoel afgestemd" : _default_nl_number(count) + " leerdoelen afgestemd"));
  return React.createElement("div", {
