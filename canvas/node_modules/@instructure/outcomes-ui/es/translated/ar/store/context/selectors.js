...
var getGroupText = function getGroupText(count) {
  ...
  return _s = count, _n = +_s, (_n === 1 ? _default_ar_number(count) + " \u0645\u062C\u0645\u0648\u0639\u0629" : _default_ar_number(count) + " \u0645\u062C\u0645\u0648\u0639\u0627\u062A");
};
...
var getOutcomeText = function getOutcomeText(count) {
  ...
  return _s2 = count, _n2 = +_s2, (_n2 === 1 ? _default_ar_number(count) + " \u0646\u062A\u064A\u062C\u0629" : _default_ar_number(count) + " \u0646\u062A\u0627\u0626\u062C");
};
