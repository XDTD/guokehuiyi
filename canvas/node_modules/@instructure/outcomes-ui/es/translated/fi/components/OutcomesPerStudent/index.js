...
var renderLoading = function renderLoading() {
  return React.createElement("div", {
    ...
    renderTitle: "Ladataan"
  }));
};

var noOutcomes = function noOutcomes() {
  return {
    heading: "Ei ole t\xE4ss\xE4 n\xE4ytett\xE4v\xE4\xE4 raporttia",
    message: "Arvioinnilla ei ole siihen kohdistettuja tuloksia. Siirry Koonti-v\xE4lilehteen kohdistaaksesi tulokset.",
...
var noStudents = function noStudents() {
  return {
    heading: "N\xE4ytt\xE4\xE4, ett\xE4 olet v\xE4h\xE4n aikaisessa",
    message: "Opiskelijoiden t\xE4ytyy tehd\xE4 arviointi loppuun ennen kuin mitk\xE4\xE4n tulokset n\xE4kyv\xE4t t\xE4\xE4ll\xE4. Palaa takaisin sen j\xE4lkeen, kun jotkut opiskelijoista ovat suorittaneet arvioinnin.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 tulos kohdistettu" : _default_fi_number(count) + " tulosta kohdistettu"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "Seuraava sivu",
      labelPrev: "Edellinen sivu"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Lis\xE4tiedot")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
