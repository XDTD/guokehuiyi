...
var _default_enCA_number = Intl.NumberFormat("en-CA", { style: "decimal" }).format,
    _dec,
    _class,
    _class2,
    _temp;
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 Outcome Aligned" : _default_enCA_number(count) + " Outcomes Aligned"));
  return React.createElement("div", {
