...
var noStudents = function noStudents() {
  return {
    ...
    message: "Eleverna m\xE5ste avsluta bed\xF6mningen innan n\xE5gra resultat f\xF6r l\xE4randem\xE5l kommer att visas h\xE4r. Kolla h\xE4r igen efter att n\xE5gra elever har slutf\xF6rt bed\xF6mningen.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 l\xE4randem\xE5l justerat" : _default_svXK12_number(count) + " l\xE4randem\xE5l justerat"));
  return React.createElement("div", {
