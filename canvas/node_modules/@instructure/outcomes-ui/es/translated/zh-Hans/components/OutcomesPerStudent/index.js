...
var noOutcomes = function noOutcomes() {
  return {
    heading: "\u6B64\u5904\u6CA1\u6709\u62A5\u544A\u53EF\u4EE5\u663E\u793A",
    message: "\u6B64\u8BC4\u4F30\u6CA1\u6709\u5339\u914D\u7684\u7ED3\u679C\u3002\u8BF7\u8F6C\u5230\u201C\u751F\u6210\u201D\u9009\u9879\u5361\u4EE5\u5339\u914D\u7ED3\u679C\u3002",
...
var noStudents = function noStudents() {
  return {
    heading: "\u770B\u6765\u60A8\u6765\u65E9\u4E86",
    message: "\u5B66\u751F\u5FC5\u987B\u5B8C\u6210\u8BC4\u4F30\u540E\uFF0C\u6B64\u5904\u624D\u4F1A\u663E\u793A\u7ED3\u679C\u3002\u4E00\u4E9B\u5B66\u751F\u5B8C\u6210\u8BC4\u4F30\u540E\uFF0C\u518D\u8FD4\u56DE\u6B64\u5904\u67E5\u770B\u3002",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = " \u8C03\u6574 " + _default_zhHans_number(count) + " \u4E2A\u7ED3\u679C";
  return React.createElement("div", {
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "\u8BE6\u60C5")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
