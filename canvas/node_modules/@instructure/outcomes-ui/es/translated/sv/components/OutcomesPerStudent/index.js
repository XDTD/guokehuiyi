...
var noOutcomes = function noOutcomes() {
  return {
    heading: "Det finns ingen rapport att visa h\xE4r",
    message: "Bed\xF6mningen har inga l\xE4randem\xE5l som justerats till den. G\xE5 till fliken Skapa f\xF6r att justera l\xE4randem\xE5l.",
...
var noStudents = function noStudents() {
  return {
    heading: "Det verkar som att du \xE4r lite tidig",
    message: "Studenterna m\xE5ste avsluta bed\xF6mningen innan n\xE5gra resultat f\xF6r l\xE4randem\xE5l kommer att visas h\xE4r. Kolla h\xE4r igen efter att n\xE5gra studenter har slutf\xF6rt bed\xF6mningen.",
...
var renderCorner = function renderCorner(count) {
  ...
  var text = (_s = count, _n = +_s, (_i = Math.floor(Math.abs(+_s)), _v = (_s + '.').split('.')[1].length, _i === 1 && _v === 0 ? "1 l\xE4randem\xE5l justerat" : _default_sv_number(count) + " l\xE4randem\xE5l justerat"));
  return React.createElement("div", {
...
var renderPagination = function renderPagination(_ref) {
  ...
  if (currentPage !== null) {
    return React.createElement(Pagination, {
      margin: "small",
      variant: "compact",
      labelNext: "N\xE4sta sida",
      labelPrev: "F\xF6reg\xE5ende sida"
  ...
  _createClass(OutcomesPerStudentReport, [{
    ...
    value: function renderReportTable() {
      ...
      return React.createElement("div", {
        ...
        role: "rowheader"
      }, React.createElement(ScreenReaderContent, null, "Detaljer")), rollups.map(function (rollup, i) {
        return (// FIXME: use stable keys here
          React.createElement("div", {
            key: headerIds[i],
            role: "gridcell"
