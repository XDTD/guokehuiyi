...
---
**/
var Tray = (_dec = (0, _testable.testable)(), _dec2 = (0, _bidirectional.bidirectional)(), _dec3 = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = _dec2(_class = _dec3(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(Tray, _Component);

  var _super = (0, _createSuper2.default)(Tray);

  function Tray() {
    var _this;

    (0, _classCallCheck2.default)(this, Tray);
  ...
  (0, _createClass2.default)(Tray, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_Portal.Portal, {
        ...
        transitionExit: true
      }, /*#__PURE__*/_react.default.createElement("span", Object.assign({}, (0, _omitProps.omitProps)(props, Tray.propTypes), {
        className: (0, _classnames2.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, styles.root, true), (0, _defineProperty2.default)(_classnames, styles.border, border), (0, _defineProperty2.default)(_classnames, styles.shadow, shadow), (0, _defineProperty2.default)(_classnames, styles[size], true), (0, _defineProperty2.default)(_classnames, styles["placement--".concat(this.props.placement)], true), _classnames)),
        ref: contentRef
      }), this.state.transitioning ? children : /*#__PURE__*/_react.default.createElement(_Dialog.Dialog, {
        as: "div",
        label: label,
   ...
   */
  placement: _propTypes.default.oneOf(['top', 'bottom', 'start', 'end']),
