...
var GridRow = (_dec = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(GridRow, [{
    key: "startAtClass",
    ...
    value: function renderChildren() {
      ...
      return _react.Children.map(children, function (child, index) {
        if ((0, _matchComponentTypes.matchComponentTypes)(child, [_GridCol.GridCol])) {
          return (0, _safeCloneElement.safeCloneElement)(child, (0, _objectSpread2.default)({}, (0, _pickProps.pickProps)(_this.props, GridRow.propTypes), {}, child.props, {
    ...
    value: function render() {
      ...
      var classes = (_classes = {}, (0, _defineProperty2.default)(_classes, styles.root, true), (0, _defineProperty2.default)(_classes, styles.lastRow, this.props.isLastRow), (0, _defineProperty2.default)(_classes, styles["hAlign--".concat(this.props.hAlign)], true), (0, _defineProperty2.default)(_classes, styles["vAlign--".concat(this.props.vAlign)], true), (0, _defineProperty2.default)(_classes, styles[this.rowSpacingClass()], true), (0, _defineProperty2.default)(_classes, styles[this.colSpacingClass()], this.props.colSpacing !== 'none'), (0, _defineProperty2.default)(_classes, styles[this.startAtClass()], !!this.props.startAt), _classes);
