...
var IconToggleEndSolid = /*#__PURE__*/function (_Component) {
  _inherits(IconToggleEndSolid, _Component);

  var _super = _createSuper(IconToggleEndSolid);

  function IconToggleEndSolid() {
    _classCallCheck(this, IconToggleEndSolid);

    return _super.apply(this, arguments);
  }

  _createClass(IconToggleEndSolid, [{
    key: "render",
  ...
  return IconToggleEndSolid;
}(Component);

IconToggleEndSolid.glyphName = 'toggle-end';
IconToggleEndSolid.variant = 'Solid';
IconToggleEndSolid.propTypes = _objectSpread({}, SVGIcon.propTypes);
