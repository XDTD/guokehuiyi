...
---
**/
var Text = (_dec = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(Text, [{
    ...
    value: function render() {
      ...
      var ElementType = (0, _getElementType.getElementType)(Text, this.props);
      return /*#__PURE__*/_react.default.createElement(ElementType, Object.assign({}, (0, _passthroughProps.passthroughProps)(this.props), {
        className: (0, _classnames2.default)((_classnames = {}, (0, _defineProperty2.default)(_classnames, styles.root, true), (0, _defineProperty2.default)(_classnames, styles[size], size), (0, _defineProperty2.default)(_classnames, styles["wrap-".concat(wrap)], wrap), (0, _defineProperty2.default)(_classnames, styles["weight-".concat(weight)], weight), (0, _defineProperty2.default)(_classnames, styles["style-".concat(fontStyle)], fontStyle), (0, _defineProperty2.default)(_classnames, styles["transform-".concat(transform)], transform), (0, _defineProperty2.default)(_classnames, styles["lineHeight-".concat(lineHeight)], lineHeight), (0, _defineProperty2.default)(_classnames, styles["letterSpacing-".concat(letterSpacing)], letterSpacing), (0, _defineProperty2.default)(_classnames, styles["color-".concat(color)], color), _classnames)),
  ...
  */
  color: _deprecated.deprecated.deprecatePropValues(_propTypes.default.oneOf(['primary', 'secondary', 'brand', 'success', 'warning', 'error', 'danger', 'alert', 'primary-inverse', 'secondary-inverse']), ['error'], 'It will be removed in version 8.0.0. Use `danger` instead.'),
