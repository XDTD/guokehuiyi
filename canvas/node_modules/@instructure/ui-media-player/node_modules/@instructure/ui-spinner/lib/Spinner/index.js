...
---
**/
var Spinner = (_dec = (0, _deprecated.deprecated)('8.0.0', {
  title: 'renderTitle'
  ...
  var _super = (0, _createSuper2.default)(Spinner);
  ...
  function Spinner(props) {
    ...
    _this.titleId = (0, _uid.uid)('Spinner');
    return _this;
  }
  ...
  (0, _createClass2.default)(Spinner, [{
    ...
    value: function render() {
      ...
      var classes = (_classes = {}, (0, _defineProperty2.default)(_classes, styles.root, true), (0, _defineProperty2.default)(_classes, styles[this.props.size], true), (0, _defineProperty2.default)(_classes, styles[this.props.variant], true), (0, _defineProperty2.default)(_classes, styles.ie11, _isIE.isIE11), _classes);

      var passthroughProps = _View.View.omitViewProps((0, _omitProps.omitProps)(this.props, Spinner.propTypes), Spinner);

      var hasTitle = this.props.renderTitle || this.props.title;

      /*#__PURE__*/
      ( /*#__PURE__*/0, _console.error)(hasTitle, '[Spinner] The renderTitle prop is necessary for screen reader support.');
      return /*#__PURE__*/_react.default.createElement(_View.View, Object.assign({}, passthroughProps, {
        ...
        id: this.titleId
      }, (0, _callRenderProp.callRenderProp)(this.props.renderTitle)), /*#__PURE__*/_react.default.createElement("g", {
        role: "presentation"
      }, this.props.variant !== 'inverse' && /*#__PURE__*/_react.default.createElement("circle", {
