...
var IconToggleStartLine = /*#__PURE__*/function (_Component) {
  _inherits(IconToggleStartLine, _Component);

  var _super = _createSuper(IconToggleStartLine);

  function IconToggleStartLine() {
    _classCallCheck(this, IconToggleStartLine);

    return _super.apply(this, arguments);
  }

  _createClass(IconToggleStartLine, [{
    key: "render",
  ...
  return IconToggleStartLine;
}(Component);

IconToggleStartLine.glyphName = 'toggle-start';
IconToggleStartLine.variant = 'Line';
IconToggleStartLine.propTypes = _objectSpread({}, SVGIcon.propTypes);
