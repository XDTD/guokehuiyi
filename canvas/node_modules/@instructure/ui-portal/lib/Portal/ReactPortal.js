...
exports.ReactPortal = exports.default = void 0;
...
@module ReactPortal
**/
var ReactPortal = (_dec = (0, _bidirectional.bidirectional)(), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(ReactPortal, _React$Component);

  var _super = (0, _createSuper2.default)(ReactPortal);

  function ReactPortal(props) {
    var _this;

    (0, _classCallCheck2.default)(this, ReactPortal);
  ...
  (0, _createClass2.default)(ReactPortal, [{
    ...
    value: function render() {
      ...
      return this.props.open && _react.default.Children.count(children) > 0 ? _reactDom.default.createPortal(children, this.insertNode()) : null;
    }
  }, {
    key: "removeNode",
    ...
    value: function insertNode() {
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["open", "insertAt", "onOpen", "onClose", "mountNode", "children", "elementRef"]); // Create node if it doesn't already exist

      if (!this.DOMNode) {
        var node = document.createElement('span');
        var attributes = (0, _objectSpread2.default)({}, (0, _passthroughProps.passthroughProps)(props), {
          dir: this.dir
        });
