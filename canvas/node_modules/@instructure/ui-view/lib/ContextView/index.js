...
---
**/
var ContextView = (_dec = (0, _themeable.themeable)(_theme.default, styles), _dec(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(ContextView, [{
    key: "render",
    value: function render() {
      ...
      var classes = (_classes = {}, (0, _defineProperty2.default)(_classes, styles.contextViewRoot, true), (0, _defineProperty2.default)(_classes, styles["placement--".concat(placement.replace(' ', '-'))], true), _classes);
      return /*#__PURE__*/_react.default.createElement(_index.View, Object.assign({}, (0, _omitProps.omitProps)(this.props, ContextView.propTypes), {
        style: style,
    ...
    get: function get() {
      return (0, _mirrorPlacement.mirrorPlacement)(this.props.placement, '-');
    }
  }]);
