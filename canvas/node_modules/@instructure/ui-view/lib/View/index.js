...
var _getShorthandPropValue = require("@instructure/ui-themeable/lib/getShorthandPropValue.js");

var _ThemeablePropTypes = require("@instructure/ui-themeable/lib/ThemeablePropTypes.js");

var _mirrorShorthandEdges = require("@instructure/ui-themeable/lib/mirrorShorthandEdges.js");

var _mirrorShorthandCorners = require("@instructure/ui-themeable/lib/mirrorShorthandCorners.js");
...
var _themeAdapter = require("./themeAdapter.js");
...
@module View
**/
var View = (_dec = (0, _deprecated.deprecated)('8.0.0', {
  focused: 'withFocusOutline',
  visualDebug: 'withVisualDebug'
}), _dec2 = (0, _bidirectional.bidirectional)(), _dec3 = (0, _themeable.themeable)(_theme.default, styles, _themeAdapter.themeAdapter), _dec(_class = _dec2(_class = _dec3(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function componentDidMount() {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        ( /*#__PURE__*/0, _console.error)(! /*#__PURE__*/function verifySpanMargin(element, margin) {
          ...
          var display = (0, _getComputedStyle.getComputedStyle)(element).display;
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props, ["children", "textAlign", "background", "display", "withVisualDebug", "width", "height", "minWidth", "minHeight", "maxWidth", "maxHeight", "overflowX", "overflowY", "stacking", "shadow", "position", "focusPosition", "focusColor", "shouldAnimateFocus", "borderColor", "className"]);
      var ElementType = (0, _getElementType.getElementType)(View, this.props);
      var withFocusOutline = this.withFocusOutline;
      var focusOutlineClasses = position === 'relative' || display === 'inline' && focusPosition === 'inset' ? (_ref = {}, (0, _defineProperty2.default)(_ref, styles.focus, true), (0, _defineProperty2.default)(_ref, styles.withFocusOutline, withFocusOutline), (0, _defineProperty2.default)(_ref, styles.shouldUseBrowserFocus, typeof withFocusOutline === 'undefined'), (0, _defineProperty2.default)(_ref, styles[this.focusRingRadius], true), (0, _defineProperty2.default)(_ref, styles["focusPosition--".concat(focusPosition)], true), (0, _defineProperty2.default)(_ref, styles["focusColor--".concat(focusColor)], true), (0, _defineProperty2.default)(_ref, styles.focusAnimation, shouldAnimateFocus), _ref) : {};
      var classes = (0, _classnames.default)((0, _objectSpread4.default)((_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, styles.root, true), (0, _defineProperty2.default)(_objectSpread2, styles.withVisualDebug, withVisualDebug || this.props.visualDebug), (0, _defineProperty2.default)(_objectSpread2, styles.withBorder, this.withBorder), (0, _defineProperty2.default)(_objectSpread2, styles["borderColor--".concat(borderColor)], this.withBorder), (0, _defineProperty2.default)(_objectSpread2, styles["textAlign--".concat(textAlign)], textAlign), (0, _defineProperty2.default)(_objectSpread2, styles["background--".concat(background)], background), (0, _defineProperty2.default)(_objectSpread2, styles["display--".concat(display)], display && display !== 'auto'), (0, _defineProperty2.default)(_objectSpread2, styles["overflowX--".concat(overflowX)], overflowX && overflowX !== 'visible'), (0, _defineProperty2.default)(_objectSpread2, styles["overflowY--".concat(overflowY)], overflowY && overflowY !== 'visible'), (0, _defineProperty2.default)(_objectSpread2, styles["stacking--".concat(stacking)], stacking), (0, _defineProperty2.default)(_objectSpread2, styles["shadow--".concat(shadow)], shadow && shadow !== 'none'), (0, _defineProperty2.default)(_objectSpread2, styles["position--".concat(position)], position !== 'static'), _objectSpread2), focusOutlineClasses, (0, _defineProperty2.default)({}, className, className)));
    ...
    get: function get() {
      ...
      if (withFocusOutline) {
        /*#__PURE__*/
        ( /*#__PURE__*/0, _console.error)(display === 'inline' || position === 'relative', '[View] the focus outline will only show if the `position` prop is `relative`.');

        /*#__PURE__*/
        ( /*#__PURE__*/0, _console.error)(display !== 'inline' || focusPosition === 'inset', '[View] when display is set to `inline` the focus outline will only show if `focusPosition` is set to `inset`.');
      }
    ...
    get: function get() {
      ...
      if (this.dir === _bidirectional.bidirectional.DIRECTION.rtl) {
        borderRadius = (0, _mirrorShorthandCorners.mirrorShorthandCorners)(borderRadius);
        borderWidth = (0, _mirrorShorthandEdges.mirrorShorthandEdges)(borderWidth);
      }

      return {
        borderRadius: (0, _getShorthandPropValue.getShorthandPropValue)('View', this.theme, borderRadius, 'borderRadius'),
        borderWidth: (0, _getShorthandPropValue.getShorthandPropValue)('View', this.theme, borderWidth, 'borderWidth')
      };
    }
  }, {
    key: "spacingStyle",
    get: function get() {
      ...
      if (this.dir === 'rtl') {
        margin = (0, _mirrorShorthandEdges.mirrorShorthandEdges)(margin);
        padding = (0, _mirrorShorthandEdges.mirrorShorthandEdges)(padding);
      }

      return {
        margin: (0, _getShorthandPropValue.getShorthandPropValue)('View', this.theme, margin, 'margin'),
        padding: (0, _getShorthandPropValue.getShorthandPropValue)('View', this.theme, padding, 'padding')
      };
    }
  }, {
    key: "offsetStyle",
    ...
    get: function get() {
      ...
      var whitelisted = (0, _pickProps.pickProps)(style || {}, {}, [// Position/calculateElementPosition:
   ...
   * to edges
   */
  borderWidth: _ThemeablePropTypes.ThemeablePropTypes.borderWidth,
   ...
   */
  borderRadius: _ThemeablePropTypes.ThemeablePropTypes.borderRadius,

  /**
   * Sets the color of the View border
   */
  borderColor: _deprecated.deprecated.deprecatePropValues(_propTypes.default.oneOf(['transparent', 'primary', 'secondary', 'brand', 'info', 'success', 'warning', 'alert', 'danger', 'default', 'inverse']), ['default', 'inverse'], function (_ref2) {
   ...
   */
  background: _deprecated.deprecated.deprecatePropValues(_propTypes.default.oneOf(['transparent', 'primary', 'secondary', 'primary-inverse', 'brand', 'info', 'alert', 'success', 'danger', 'warning', 'default', 'light', 'inverse']), ['default', 'inverse', 'light'], function (_ref3) {
...
View.omitViewProps = function (props, Component) {
  if (process.env.NODE_ENV !== 'production') {
    Object.keys((0, _pickProps.pickProps)(props, View.propTypes)).forEach(function (prop) {
      /*#__PURE__*/
      ( /*#__PURE__*/0, _console.error)(false, "[".concat(Component.displayName, "] prop '").concat(prop, "' is not allowed."));
    });
  }

  return (0, _omitProps.omitProps)(props, View.propTypes);
};
