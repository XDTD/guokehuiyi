...
var Announcer = function (_Component) {
  ...
  function Announcer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      politeMessage1: '',
      politeMessage2: ''
    }, _this.setAlternatePolite = false, _this.setAlternateAssertive = false, _temp), _possibleConstructorReturn(_this, _ret);
  }

  Announcer.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
